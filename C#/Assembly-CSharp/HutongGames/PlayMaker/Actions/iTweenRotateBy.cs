...
// Type: HutongGames.PlayMaker.Actions.iTweenRotateBy
...
[HutongGames.PlayMaker.Tooltip("Multiplies supplied values by 360 and rotates a GameObject by calculated amount over time.")]
public class iTweenRotateBy : iTweenFsmAction
{
  ...
  public FsmString id;
  [HutongGames.PlayMaker.Tooltip("A vector that will multiply current GameObjects rotation.")]
  [RequiredField]
