...
// Type: InControl.NativeProfile.SteamWindowsNativeProfile
...
public class SteamWindowsNativeProfile : NativeInputDeviceProfile
{
  public SteamWindowsNativeProfile()
  {
    ...
    this.Meta = "Steam Controller on Windows";
    this.DeviceClass = InputDeviceClass.Controller;
    this.DeviceStyle = InputDeviceStyle.Steam;
    this.IncludePlatforms = new string[1]{ "Windows" };
    this.Matchers = new NativeInputDeviceMatcher[1]
    {
      new NativeInputDeviceMatcher()
      {
        VendorID = new ushort?((ushort) 10462),
        ProductID = new ushort?((ushort) 4607)
      }
    };
