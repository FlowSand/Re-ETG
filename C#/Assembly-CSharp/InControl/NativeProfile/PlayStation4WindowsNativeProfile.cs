...
// Type: InControl.NativeProfile.PlayStation4WindowsNativeProfile
...
public class PlayStation4WindowsNativeProfile : NativeInputDeviceProfile
{
  public PlayStation4WindowsNativeProfile()
  {
    ...
    this.Meta = "PlayStation 4 Controller on Windows";
    ...
    this.Matchers = new NativeInputDeviceMatcher[3]
    {
      ...
      {
        VendorID = new ushort?((ushort) 1356),
        ProductID = new ushort?((ushort) 1476)
      },
      new NativeInputDeviceMatcher()
      {
        VendorID = new ushort?((ushort) 1356),
        ProductID = new ushort?((ushort) 2508)
      },
      new NativeInputDeviceMatcher()
      {
        VendorID = new ushort?((ushort) 1356),
