...
// Type: InControl.SpeedlinkStrikeWinProfile
...
public class SpeedlinkStrikeWinProfile : UnityInputDeviceProfile
{
  ...
  {
    this.Name = "Speedlink Strike Controller";
    this.Meta = "Speedlink Strike Controller on Windows";
    this.DeviceClass = InputDeviceClass.Controller;
    this.IncludePlatforms = new string[1]{ "Win" };
