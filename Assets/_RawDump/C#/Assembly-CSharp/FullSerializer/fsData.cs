...
public sealed class fsData
{
  ...
  {
    return new fsData(new Dictionary<string, fsData>(!fsConfig.IsCaseSensitive ? (IEqualityComparer<string>) StringComparer.CurrentCultureIgnoreCase : (IEqualityComparer<string>) StringComparer.CurrentCulture));
  }
  ...
  internal void BecomeDictionary() => this._value = (object) new Dictionary<string, fsData>();
