...
// Type: InControl.MadCatzMicroCTRLRAmazonProfile
...
public class MadCatzMicroCTRLRAmazonProfile : UnityInputDeviceProfile
{
  ...
  {
    this.Name = "Mad Catz Micro C.T.R.L.R Controller";
    this.Meta = "Mad Catz Micro C.T.R.L.R Controller on Amazon Fire TV";
