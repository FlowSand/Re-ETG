...
public class PlanarReflection : MonoBehaviour
{
  ...
  public void Start()
  {
    this.sharedMaterial = ((WaterBase) this.gameObject.GetComponent(typeof (WaterBase))).sharedMaterial;
  }
  ...
  {
    RenderTexture textureFor = new RenderTexture(Mathf.FloorToInt((float) cam.pixelWidth * 0.5f), Mathf.FloorToInt((float) cam.pixelHeight * 0.5f), 24);
