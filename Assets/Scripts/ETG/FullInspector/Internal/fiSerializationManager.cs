...
public static class fiSerializationManager
{
  ...
  static fiSerializationManager()
  {
    ...
    if (fiSerializationManager._f__mg_cache0 == null)
    {
      // ISSUE: reference to a compiler-generated field
      fiSerializationManager._f__mg_cache0 = new System.Action(fiSerializationManager.OnEditorUpdate);
    }
    // ISSUE: reference to a compiler-generated field
    fiLateBindings.EditorApplication.AddUpdateFunc(fiSerializationManager._f__mg_cache0);
  }
