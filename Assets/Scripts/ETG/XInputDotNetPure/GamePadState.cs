...
namespace XInputDotNetPure
{
    public struct GamePadState
    {
        ...
        internal GamePadState(bool isConnected, GamePadState.RawState rawState)
        {
            ...
            this.buttons = new GamePadButtons(((int) rawState.Gamepad.dwButtons & 16) == 0 ? ButtonState.Released : ButtonState.Pressed, ((int) rawState.Gamepad.dwButtons & 32) == 0 ? ButtonState.Released : ButtonState.Pressed, ((int) rawState.Gamepad.dwButtons & 64) == 0 ? ButtonState.Released : ButtonState.Pressed, ((int) rawState.Gamepad.dwButtons & 128) == 0 ? ButtonState.Released : ButtonState.Pressed, ((int) rawState.Gamepad.dwButtons & 256) == 0 ? ButtonState.Released : ButtonState.Pressed, ((int) rawState.Gamepad.dwButtons & 512) == 0 ? ButtonState.Released : ButtonState.Pressed, ((int) rawState.Gamepad.dwButtons & 4096) == 0 ? ButtonState.Released : ButtonState.Pressed, ((int) rawState.Gamepad.dwButtons & 8192) == 0 ? ButtonState.Released : ButtonState.Pressed, ((int) rawState.Gamepad.dwButtons & 16384) == 0 ? ButtonState.Released : ButtonState.Pressed, ((int) rawState.Gamepad.dwButtons & 32768) == 0 ? ButtonState.Released : ButtonState.Pressed);
