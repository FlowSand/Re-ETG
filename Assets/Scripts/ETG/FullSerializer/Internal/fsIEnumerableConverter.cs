...
// Type: FullSerializer.Internal.fsIEnumerableConverter
...
namespace FullSerializer.Internal
{
  public class fsIEnumerableConverter : fsConverter
  {
    ...
    {
      type.GetFlattenedMethod("Clear")?.Invoke(instance, (object[]) null);
    }
    ...
    private static int TryGetExistingSize(Type type, object instance)
    {
      ...
      return flattenedProperty != null ? (int) flattenedProperty.GetGetMethod().Invoke(instance, (object[]) null) : 0;
    }
