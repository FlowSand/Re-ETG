...
public class AkSoundEngine
{
  ...
  public const int AK_SIMD_ALIGNMENT = 16 /*0x10*/;
  public const int AK_BUFFER_ALIGNMENT = 16 /*0x10*/;
  public const int AK_XAUDIO2_FLAGS = 0;
  public const int AK_MAX_PATH = 260;
  public const int AK_BANK_PLATFORM_DATA_ALIGNMENT = 16 /*0x10*/;
  public const uint AK_INVALID_PLUGINID = 4294967295 /*0xFFFFFFFF*/;
  public const ulong AK_INVALID_GAME_OBJECT = 18446744073709551615 /*0xFFFFFFFFFFFFFFFF*/;
  public const uint AK_INVALID_UNIQUE_ID = 0;
  public const uint AK_INVALID_RTPC_ID = 0;
  public const uint AK_INVALID_LISTENER_INDEX = 4294967295 /*0xFFFFFFFF*/;
  ...
  public const uint AK_INVALID_FILE_ID = 4294967295 /*0xFFFFFFFF*/;
  public const uint AK_INVALID_DEVICE_ID = 4294967295 /*0xFFFFFFFF*/;
  ...
  public const uint AK_MIXER_FX_SLOT = 4294967295 /*0xFFFFFFFF*/;
  ...
  public const uint AK_LISTENERS_MASK_ALL = 4294967295 /*0xFFFFFFFF*/;
  public const int NULL = 0;
  public const int AKCURVEINTERPOLATION_NUM_STORAGE_BIT = 5;
  public const int AK_MAX_LANGUAGE_NAME_SIZE = 32 /*0x20*/;
  public const int AKCOMPANYID_AUDIOKINETIC_EXTERNAL = 1;
  public const int AKCOMPANYID_MCDSP = 256 /*0x0100*/;
  ...
  public const int AKCODECID_MIDI = 16 /*0x10*/;
  ...
  public const int AK_WAVE_FORMAT_VORBIS = 65535 /*0xFFFF*/;
  ...
  public const int AK_MIDI_EVENT_TYPE_NOTE_OFF = 128 /*0x80*/;
  public const int AK_MIDI_EVENT_TYPE_NOTE_ON = 144 /*0x90*/;
  public const int AK_MIDI_EVENT_TYPE_NOTE_AFTERTOUCH = 160 /*0xA0*/;
  public const int AK_MIDI_EVENT_TYPE_CONTROLLER = 176 /*0xB0*/;
  public const int AK_MIDI_EVENT_TYPE_PROGRAM_CHANGE = 192 /*0xC0*/;
  public const int AK_MIDI_EVENT_TYPE_CHANNEL_AFTERTOUCH = 208 /*0xD0*/;
  public const int AK_MIDI_EVENT_TYPE_PITCH_BEND = 224 /*0xE0*/;
  public const int AK_MIDI_EVENT_TYPE_SYSEX = 240 /*0xF0*/;
  public const int AK_MIDI_EVENT_TYPE_ESCAPE = 247;
  public const int AK_MIDI_EVENT_TYPE_META = 255 /*0xFF*/;
  ...
  public const int AK_MIDI_CC_GEN_SLIDER_1 = 16 /*0x10*/;
  ...
  public const int AK_MIDI_CC_CTRL_31_COARSE = 31 /*0x1F*/;
  public const int AK_MIDI_CC_BANK_SELECT_FINE = 32 /*0x20*/;
  ...
  public const int AK_MIDI_CC_CTRL_31_FINE = 63 /*0x3F*/;
  public const int AK_MIDI_CC_HOLD_PEDAL = 64 /*0x40*/;
  ...
  public const int AK_MIDI_CC_GENERAL_BUTTON_1 = 80 /*0x50*/;
  ...
  public const int AK_MIDI_CC_DATA_BUTTON_P1 = 96 /*0x60*/;
  ...
  public const int AK_MIDI_CC_OMNI_POLYPHONIC_ON = 127 /*0x7F*/;
  ...
  public const int AK_SPEAKER_BACK_LEFT = 16 /*0x10*/;
  public const int AK_SPEAKER_BACK_RIGHT = 32 /*0x20*/;
  public const int AK_SPEAKER_BACK_CENTER = 256 /*0x0100*/;
  public const int AK_SPEAKER_SIDE_LEFT = 512 /*0x0200*/;
  public const int AK_SPEAKER_SIDE_RIGHT = 1024 /*0x0400*/;
  public const int AK_SPEAKER_TOP = 2048 /*0x0800*/;
  public const int AK_SPEAKER_HEIGHT_FRONT_LEFT = 4096 /*0x1000*/;
  public const int AK_SPEAKER_HEIGHT_FRONT_CENTER = 8192 /*0x2000*/;
  public const int AK_SPEAKER_HEIGHT_FRONT_RIGHT = 16384 /*0x4000*/;
  public const int AK_SPEAKER_HEIGHT_BACK_LEFT = 32768 /*0x8000*/;
  public const int AK_SPEAKER_HEIGHT_BACK_CENTER = 65536 /*0x010000*/;
  public const int AK_SPEAKER_HEIGHT_BACK_RIGHT = 131072 /*0x020000*/;
  ...
  public const int AK_SPEAKER_SETUP_HEIGHT_4 = 184320 /*0x02D000*/;
  public const int AK_SPEAKER_SETUP_HEIGHT_5 = 192512 /*0x02F000*/;
  public const int AK_SPEAKER_SETUP_HEIGHT_ALL = 258048 /*0x03F000*/;
  ...
  {
    get => AkSoundEnginePINVOKE.CSharp_AK_LE_NATIVE_BITSPERSAMPLE_get();
  }

  public static uint AK_LE_NATIVE_SAMPLETYPE
  {
    get => AkSoundEnginePINVOKE.CSharp_AK_LE_NATIVE_SAMPLETYPE_get();
  }

  public static uint AK_LE_NATIVE_INTERLEAVE
  {
    get => AkSoundEnginePINVOKE.CSharp_AK_LE_NATIVE_INTERLEAVE_get();
  }
  ...
  public static uint DynamicSequenceOpen(
    ...
    object in_pCookie,
    AkDynamicSequenceType in_eDynamicSequenceType)
  {
    ...
    in_pCookie = (object) AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
    uint in_playingID = AkSoundEnginePINVOKE.CSharp_DynamicSequenceOpen__SWIG_0(akGameObjectId, in_uFlags, in_uFlags == 0U ? IntPtr.Zero : (IntPtr) 1, in_pCookie == null ? IntPtr.Zero : (IntPtr) in_pCookie.GetHashCode(), (int) in_eDynamicSequenceType);
    AkCallbackManager.SetLastAddedPlayingID(in_playingID);
    return in_playingID;
  }
    ...
    object in_pCookie)
  {
    ...
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
    in_pCookie = (object) AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
    uint in_playingID = AkSoundEnginePINVOKE.CSharp_DynamicSequenceOpen__SWIG_1(akGameObjectId, in_uFlags, in_uFlags == 0U ? IntPtr.Zero : (IntPtr) 1, in_pCookie == null ? IntPtr.Zero : (IntPtr) in_pCookie.GetHashCode());
    AkCallbackManager.SetLastAddedPlayingID(in_playingID);
    return in_playingID;
  }
  ...
  public static uint DynamicSequenceOpen(GameObject in_gameObjectID, uint in_uFlags)
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
    uint in_playingID = AkSoundEnginePINVOKE.CSharp_DynamicSequenceOpen__SWIG_2(akGameObjectId, in_uFlags);
    AkCallbackManager.SetLastAddedPlayingID(in_playingID);
    return in_playingID;
  }
  ...
  public static uint DynamicSequenceOpen(GameObject in_gameObjectID)
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
    uint in_playingID = AkSoundEnginePINVOKE.CSharp_DynamicSequenceOpen__SWIG_3(akGameObjectId);
    AkCallbackManager.SetLastAddedPlayingID(in_playingID);
    return in_playingID;
  }
  ...
  public static AKRESULT DynamicSequencePlay(
    uint in_playingID,
  ...
  public static AKRESULT DynamicSequencePause(
    uint in_playingID,
    int in_uTransitionDuration,
    AkCurveInterpolation in_eFadeCurve)
  {
  ...
  public static AKRESULT DynamicSequenceResume(
    uint in_playingID,
    int in_uTransitionDuration,
    AkCurveInterpolation in_eFadeCurve)
  {
  ...
  public static AKRESULT DynamicSequenceStop(
    uint in_playingID,
    int in_uTransitionDuration,
    AkCurveInterpolation in_eFadeCurve)
  {
  ...
  public static AKRESULT DynamicSequenceGetPauseTimes(
    uint in_playingID,
    out uint out_uTime,
    out uint out_uDuration)
  {
  ...
  public static AkPlaylist DynamicSequenceLockPlaylist(uint in_playingID)
  {
    ...
    return !(cPtr == IntPtr.Zero) ? new AkPlaylist(cPtr, false) : (AkPlaylist) null;
  }
  ...
  public static bool IsInitialized() => AkSoundEnginePINVOKE.CSharp_IsInitialized();
  ...
  public static AKRESULT GetSpeakerAngles(
    float[] io_pfSpeakerAngles,
    ref uint io_uNumAngles,
    out float out_fHeightAngle,
    ulong in_idOutput)
  {
  ...
  public static AKRESULT SetSpeakerAngles(
    float[] in_pfSpeakerAngles,
    uint in_uNumAngles,
    float in_fHeightAngle,
    ulong in_idOutput)
  {
    ...
    uint in_PlayingID)
  {
    ...
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
    in_pCookie = (object) AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
    uint in_playingID = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_0(in_eventID, akGameObjectId, in_uFlags, in_uFlags == 0U ? IntPtr.Zero : (IntPtr) 1, in_pCookie == null ? IntPtr.Zero : (IntPtr) in_pCookie.GetHashCode(), in_cExternals, AkExternalSourceInfo.getCPtr(in_pExternalSources), in_PlayingID);
    AkCallbackManager.SetLastAddedPlayingID(in_playingID);
    return in_playingID;
  }
    ...
    AkExternalSourceInfo in_pExternalSources)
  {
    ...
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
    in_pCookie = (object) AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
    uint in_playingID = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_1(in_eventID, akGameObjectId, in_uFlags, in_uFlags == 0U ? IntPtr.Zero : (IntPtr) 1, in_pCookie == null ? IntPtr.Zero : (IntPtr) in_pCookie.GetHashCode(), in_cExternals, AkExternalSourceInfo.getCPtr(in_pExternalSources));
    AkCallbackManager.SetLastAddedPlayingID(in_playingID);
    return in_playingID;
  }
    ...
    uint in_cExternals)
  {
    ...
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
    in_pCookie = (object) AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
    uint in_playingID = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_2(in_eventID, akGameObjectId, in_uFlags, in_uFlags == 0U ? IntPtr.Zero : (IntPtr) 1, in_pCookie == null ? IntPtr.Zero : (IntPtr) in_pCookie.GetHashCode(), in_cExternals);
    AkCallbackManager.SetLastAddedPlayingID(in_playingID);
    return in_playingID;
  }
    ...
    object in_pCookie)
  {
    ...
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
    in_pCookie = (object) AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
    uint in_playingID = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_3(in_eventID, akGameObjectId, in_uFlags, in_uFlags == 0U ? IntPtr.Zero : (IntPtr) 1, in_pCookie == null ? IntPtr.Zero : (IntPtr) in_pCookie.GetHashCode());
    AkCallbackManager.SetLastAddedPlayingID(in_playingID);
    return in_playingID;
  }
  ...
  public static uint PostEvent(uint in_eventID, GameObject in_gameObjectID, uint in_uFlags)
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
    uint in_playingID = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_4(in_eventID, akGameObjectId, in_uFlags);
    AkCallbackManager.SetLastAddedPlayingID(in_playingID);
    return in_playingID;
  }
  ...
  public static uint PostEvent(uint in_eventID, GameObject in_gameObjectID)
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
    uint in_playingID = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_5(in_eventID, akGameObjectId);
    AkCallbackManager.SetLastAddedPlayingID(in_playingID);
    return in_playingID;
  }
    ...
    uint in_PlayingID)
  {
    ...
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
    in_pCookie = (object) AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
    uint in_playingID = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_6(in_pszEventName, akGameObjectId, in_uFlags, in_uFlags == 0U ? IntPtr.Zero : (IntPtr) 1, in_pCookie == null ? IntPtr.Zero : (IntPtr) in_pCookie.GetHashCode(), in_cExternals, AkExternalSourceInfo.getCPtr(in_pExternalSources), in_PlayingID);
    AkCallbackManager.SetLastAddedPlayingID(in_playingID);
    return in_playingID;
  }
    ...
    AkExternalSourceInfo in_pExternalSources)
  {
    ...
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
    in_pCookie = (object) AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
    uint in_playingID = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_7(in_pszEventName, akGameObjectId, in_uFlags, in_uFlags == 0U ? IntPtr.Zero : (IntPtr) 1, in_pCookie == null ? IntPtr.Zero : (IntPtr) in_pCookie.GetHashCode(), in_cExternals, AkExternalSourceInfo.getCPtr(in_pExternalSources));
    AkCallbackManager.SetLastAddedPlayingID(in_playingID);
    return in_playingID;
  }
    ...
    uint in_cExternals)
  {
    ...
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
    in_pCookie = (object) AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
    uint in_playingID = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_8(in_pszEventName, akGameObjectId, in_uFlags, in_uFlags == 0U ? IntPtr.Zero : (IntPtr) 1, in_pCookie == null ? IntPtr.Zero : (IntPtr) in_pCookie.GetHashCode(), in_cExternals);
    AkCallbackManager.SetLastAddedPlayingID(in_playingID);
    return in_playingID;
  }
    ...
    object in_pCookie)
  {
    ...
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
    in_pCookie = (object) AkCallbackManager.EventCallbackPackage.Create(in_pfnCallback, in_pCookie, ref in_uFlags);
    uint in_playingID = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_9(in_pszEventName, akGameObjectId, in_uFlags, in_uFlags == 0U ? IntPtr.Zero : (IntPtr) 1, in_pCookie == null ? IntPtr.Zero : (IntPtr) in_pCookie.GetHashCode());
    AkCallbackManager.SetLastAddedPlayingID(in_playingID);
    return in_playingID;
  }
  ...
  public static uint PostEvent(string in_pszEventName, GameObject in_gameObjectID, uint in_uFlags)
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
    uint in_playingID = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_10(in_pszEventName, akGameObjectId, in_uFlags);
    AkCallbackManager.SetLastAddedPlayingID(in_playingID);
    return in_playingID;
  }
  ...
  public static uint PostEvent(string in_pszEventName, GameObject in_gameObjectID)
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
    uint in_playingID = AkSoundEnginePINVOKE.CSharp_PostEvent__SWIG_11(in_pszEventName, akGameObjectId);
    AkCallbackManager.SetLastAddedPlayingID(in_playingID);
    return in_playingID;
  }
  ...
  public static AKRESULT PostMIDIOnEvent(
    uint in_eventID,
    GameObject in_gameObjectID,
    AkMIDIPostArray in_pPosts,
    ushort in_uNumPosts)
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
  ...
  public static AKRESULT PinEventInStreamCache(
    uint in_eventID,
    char in_uActivePriority,
    char in_uInactivePriority)
  {
  ...
  public static AKRESULT GetBufferStatusForPinnedEvent(
    uint in_eventID,
    out float out_fPercentBuffered,
    out int out_bCachePinnedMemoryFull)
  {
  ...
  public static AKRESULT SeekOnEvent(
    uint in_eventID,
    GameObject in_gameObjectID,
    int in_iPosition,
  ...
  public static AKRESULT GetSourcePlayPosition(
    uint in_PlayingID,
    out int out_puPosition,
  ...
  public static AKRESULT GetSourceStreamBuffering(
    uint in_PlayingID,
    out int out_buffering,
    out int out_bIsBuffering)
  {
  ...
  public static void StopPlayingID(
    uint in_playingID,
    int in_uTransitionDuration,
    AkCurveInterpolation in_eFadeCurve)
  {
  ...
  public static AKRESULT SendPluginCustomGameData(
    uint in_busID,
    GameObject in_busObjectID,
    AkPluginType in_eType,
    uint in_uCompanyID,
    uint in_uPluginID,
    IntPtr in_pData,
    uint in_uSizeInBytes)
  {
  ...
  public static AKRESULT SetMultiplePositions(
    GameObject in_GameObjectID,
    AkPositionArray in_pPositions,
    ushort in_NumPositions,
  ...
  public static AKRESULT SetMultiplePositions(
    GameObject in_GameObjectID,
    AkChannelEmitterArray in_pPositions,
    ushort in_NumPositions,
    AkMultiPositionType in_eMultiPositionType)
  {
  ...
  public static AKRESULT SetScalingFactor(
    GameObject in_GameObjectID,
    float in_fAttenuationScalingFactor)
  {
  ...
  public static AKRESULT ClearBanks() => (AKRESULT) AkSoundEnginePINVOKE.CSharp_ClearBanks();
  ...
  public static AKRESULT LoadBank(
    IntPtr in_pInMemoryBankPtr,
    uint in_uInMemoryBankSize,
    out uint out_bankID)
  {
  ...
  public static AKRESULT LoadBank(
    string in_pszString,
    AkCallbackManager.BankCallback in_pfnBankCallback,
    object in_pCookie,
    int in_memPoolId,
    out uint out_bankID)
  {
    in_pCookie = (object) new AkCallbackManager.BankCallbackPackage(in_pfnBankCallback, in_pCookie);
  ...
  public static AKRESULT UnloadBank(
    string in_pszString,
    IntPtr in_pInMemoryBankPtr,
    out int out_pMemPoolId)
  {
  ...
  public static AKRESULT PrepareBank(
    AkPreparationType in_PreparationType,
    string in_pszString,
    AkBankContent in_uFlags)
  {
  ...
  public static AKRESULT PrepareEvent(
    AkPreparationType in_PreparationType,
    string[] in_ppszString,
    uint in_uNumEvent)
  {
    int num1 = 0;
    foreach (string str in in_ppszString)
      num1 += str.Length + 1;
    int num2 = 2;
    IntPtr num3 = Marshal.AllocHGlobal(num1 * num2);
    Marshal.WriteInt16(num3, (short) in_ppszString.Length);
    IntPtr destination = (IntPtr) (num3.ToInt64() + (long) num2);
    foreach (string str in in_ppszString)
    {
      Marshal.Copy(str.ToCharArray(), 0, destination, str.Length);
      IntPtr ptr = (IntPtr) (destination.ToInt64() + (long) (num2 * str.Length));
      Marshal.WriteInt16(ptr, (short) 0);
      destination = (IntPtr) (ptr.ToInt64() + (long) num2);
    }
    try
    {
      return (AKRESULT) AkSoundEnginePINVOKE.CSharp_PrepareEvent__SWIG_0((int) in_PreparationType, num3, in_uNumEvent);
    }
    finally
    {
    ...
    object in_pCookie)
  {
    ...
    try
    {
      return (AKRESULT) AkSoundEnginePINVOKE.CSharp_PrepareEvent__SWIG_2((int) in_PreparationType, num3, in_uNumEvent, IntPtr.Zero, in_pCookie == null ? IntPtr.Zero : (IntPtr) in_pCookie.GetHashCode());
    }
    finally
    {
      Marshal.FreeHGlobal(num3);
  ...
  public static AKRESULT PrepareGameSyncs(
    ...
    string in_pszGroupName,
    string[] in_ppszGameSyncName,
    uint in_uNumGameSyncs)
  {
    int num1 = 0;
    ...
    int num2 = 2;
    IntPtr num3 = Marshal.AllocHGlobal(num1 * num2);
    Marshal.WriteInt16(num3, (short) in_ppszGameSyncName.Length);
    IntPtr destination = (IntPtr) (num3.ToInt64() + (long) num2);
    foreach (string str in in_ppszGameSyncName)
    {
      Marshal.Copy(str.ToCharArray(), 0, destination, str.Length);
    ...
    try
    {
      return (AKRESULT) AkSoundEnginePINVOKE.CSharp_PrepareGameSyncs__SWIG_0((int) in_PreparationType, (int) in_eGameSyncType, in_pszGroupName, num3, in_uNumGameSyncs);
    }
    finally
    {
      Marshal.FreeHGlobal(num3);
    ...
    object in_pCookie)
  {
    ...
    try
    {
      return (AKRESULT) AkSoundEnginePINVOKE.CSharp_PrepareGameSyncs__SWIG_2((int) in_PreparationType, (int) in_eGameSyncType, in_pszGroupName, num3, in_uNumGameSyncs, IntPtr.Zero, in_pCookie == null ? IntPtr.Zero : (IntPtr) in_pCookie.GetHashCode());
    }
    finally
    {
      Marshal.FreeHGlobal(num3);
  ...
  {
    ulong akGameObjectId1 = AkSoundEngine.GetAkGameObjectID(in_emitterGameObj);
    AkSoundEngine.PreGameObjectAPICall(in_emitterGameObj, akGameObjectId1);
    ...
    return (AKRESULT) AkSoundEnginePINVOKE.CSharp_AddListener(akGameObjectId1, akGameObjectId2);
  }
  ...
  public static AKRESULT RemoveListener(GameObject in_emitterGameObj, GameObject in_listenerGameObj)
  {
    ...
    ulong akGameObjectId2 = AkSoundEngine.GetAkGameObjectID(in_listenerGameObj);
    AkSoundEngine.PreGameObjectAPICall(in_listenerGameObj, akGameObjectId2);
    return (AKRESULT) AkSoundEnginePINVOKE.CSharp_RemoveListener(akGameObjectId1, akGameObjectId2);
  }
  ...
  public static AKRESULT SetListenerSpatialization(
    GameObject in_uListenerID,
    bool in_bSpatialized,
    AkChannelConfig in_channelConfig,
    float[] in_pVolumeOffsets)
  {
  ...
  public static AKRESULT SetRTPCValue(
    uint in_rtpcID,
    float in_value,
    GameObject in_gameObjectID,
    int in_uValueChangeDuration,
    AkCurveInterpolation in_eFadeCurve,
  ...
  public static AKRESULT SetRTPCValueByPlayingID(
    uint in_rtpcID,
    float in_value,
    uint in_playingID,
    int in_uValueChangeDuration,
  ...
  public static AKRESULT ResetRTPCValue(
    uint in_rtpcID,
    GameObject in_gameObjectID,
    int in_uValueChangeDuration,
    AkCurveInterpolation in_eFadeCurve,
  ...
  public static AKRESULT SetSwitch(
    uint in_switchGroup,
    uint in_switchState,
    GameObject in_gameObjectID)
  {
  ...
  public static AKRESULT SetSwitch(
    string in_pszSwitchGroup,
    string in_pszSwitchState,
    GameObject in_gameObjectID)
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
  ...
  public static AKRESULT SetGameObjectAuxSendValues(
    GameObject in_gameObjectID,
    AkAuxSendArray in_aAuxSendValues,
    uint in_uNumSendValues)
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
  ...
  public static AKRESULT SetGameObjectOutputBusVolume(
    GameObject in_emitterObjID,
    GameObject in_listenerObjID,
    float in_fControlValue)
  {
    ulong akGameObjectId1 = AkSoundEngine.GetAkGameObjectID(in_emitterObjID);
    AkSoundEngine.PreGameObjectAPICall(in_emitterObjID, akGameObjectId1);
    ...
    return (AKRESULT) AkSoundEnginePINVOKE.CSharp_SetGameObjectOutputBusVolume(akGameObjectId1, akGameObjectId2, in_fControlValue);
  }

  public static AKRESULT SetActorMixerEffect(
    uint in_audioNodeID,
    uint in_uFXIndex,
    uint in_shareSetID)
  {
  ...
  public static AKRESULT SetObjectObstructionAndOcclusion(
    GameObject in_EmitterID,
    GameObject in_ListenerID,
    float in_fObstructionLevel,
    float in_fOcclusionLevel)
  {
    ulong akGameObjectId1 = AkSoundEngine.GetAkGameObjectID(in_EmitterID);
    AkSoundEngine.PreGameObjectAPICall(in_EmitterID, akGameObjectId1);
    ...
    return (AKRESULT) AkSoundEnginePINVOKE.CSharp_SetObjectObstructionAndOcclusion(akGameObjectId1, akGameObjectId2, in_fObstructionLevel, in_fOcclusionLevel);
  }

  public static AKRESULT SetMultipleObstructionAndOcclusion(
    GameObject in_EmitterID,
    GameObject in_uListenerID,
    AkObstructionOcclusionValues in_fObstructionOcclusionValues,
    uint in_uNumOcclusionObstruction)
  {
    ulong akGameObjectId1 = AkSoundEngine.GetAkGameObjectID(in_EmitterID);
    AkSoundEngine.PreGameObjectAPICall(in_EmitterID, akGameObjectId1);
    ...
    return (AKRESULT) AkSoundEnginePINVOKE.CSharp_SetMultipleObstructionAndOcclusion(akGameObjectId1, akGameObjectId2, AkObstructionOcclusionValues.getCPtr(in_fObstructionOcclusionValues), in_uNumOcclusionObstruction);
  }
  ...
  public static AKRESULT Suspend() => (AKRESULT) AkSoundEnginePINVOKE.CSharp_Suspend__SWIG_1();
  ...
  public static uint GetBufferTick() => AkSoundEnginePINVOKE.CSharp_GetBufferTick();

  public static byte AK_INVALID_MIDI_CHANNEL
  {
    get => AkSoundEnginePINVOKE.CSharp_AK_INVALID_MIDI_CHANNEL_get();
  }

  public static byte AK_INVALID_MIDI_NOTE => AkSoundEnginePINVOKE.CSharp_AK_INVALID_MIDI_NOTE_get();

  public static AKRESULT GetPlayingSegmentInfo(
    uint in_PlayingID,
  ...
  public static AKRESULT PostCode(
    AkMonitorErrorCode in_eError,
    AkMonitorErrorLevel in_eErrorLevel,
    uint in_playingID,
    GameObject in_gameObjID,
    uint in_audioNodeID,
    bool in_bIsBus)
  {
  ...
  public static AKRESULT PostString(
    string in_pszError,
    AkMonitorErrorLevel in_eErrorLevel,
    uint in_playingID,
    GameObject in_gameObjID,
  ...
  public static int GetTimeStamp() => AkSoundEnginePINVOKE.CSharp_GetTimeStamp();
  ...
  public static uint ResolveDialogueEvent(
    uint in_eventID,
    uint[] in_aArgumentValues,
    uint in_uNumArguments,
    uint in_idSequence)
  {
  ...
  public static AKRESULT GetDialogueEventCustomPropertyValue(
    uint in_eventID,
    uint in_uPropID,
    out int out_iValue)
  {
  ...
  public static AKRESULT GetRTPCValue(
    uint in_rtpcID,
    GameObject in_gameObjectID,
    uint in_playingID,
    out float out_rValue,
    ref int io_rValueType)
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
  ...
  public static AKRESULT GetSwitch(
    uint in_switchGroup,
    GameObject in_gameObjectID,
    out uint out_rSwitchState)
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
  ...
  public static AKRESULT GetSwitch(
    string in_pstrSwitchGroupName,
    GameObject in_GameObj,
    out uint out_rSwitchState)
  {
  ...
  public static AKRESULT GetGameObjectAuxSendValues(
    GameObject in_gameObjectID,
    AkAuxSendArray out_paAuxSendValues,
  ...
  public static AKRESULT GetGameObjectDryLevelValue(
    GameObject in_EmitterID,
    GameObject in_ListenerID,
    out float out_rfControlValue)
  {
    ulong akGameObjectId1 = AkSoundEngine.GetAkGameObjectID(in_EmitterID);
    AkSoundEngine.PreGameObjectAPICall(in_EmitterID, akGameObjectId1);
    ulong akGameObjectId2 = AkSoundEngine.GetAkGameObjectID(in_ListenerID);
    AkSoundEngine.PreGameObjectAPICall(in_ListenerID, akGameObjectId2);
    return (AKRESULT) AkSoundEnginePINVOKE.CSharp_GetGameObjectDryLevelValue(akGameObjectId1, akGameObjectId2, out out_rfControlValue);
  }

  public static AKRESULT GetObjectObstructionAndOcclusion(
    GameObject in_EmitterID,
    GameObject in_ListenerID,
    out float out_rfObstructionLevel,
    out float out_rfOcclusionLevel)
  {
    ulong akGameObjectId1 = AkSoundEngine.GetAkGameObjectID(in_EmitterID);
    AkSoundEngine.PreGameObjectAPICall(in_EmitterID, akGameObjectId1);
    ulong akGameObjectId2 = AkSoundEngine.GetAkGameObjectID(in_ListenerID);
    AkSoundEngine.PreGameObjectAPICall(in_ListenerID, akGameObjectId2);
    return (AKRESULT) AkSoundEnginePINVOKE.CSharp_GetObjectObstructionAndOcclusion(akGameObjectId1, akGameObjectId2, out out_rfObstructionLevel, out out_rfOcclusionLevel);
  }

  public static AKRESULT QueryAudioObjectIDs(
    uint in_eventID,
    ref uint io_ruNumItems,
  ...
  public static AKRESULT GetPositioningInfo(
    uint in_ObjectID,
  ...
  public static AKRESULT GetPlayingIDsFromGameObject(
    GameObject in_GameObjId,
    ref uint io_ruNumIDs,
    uint[] out_aPlayingIDs)
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(in_GameObjId);
    AkSoundEngine.PreGameObjectAPICall(in_GameObjId, akGameObjectId);
  ...
  public static AKRESULT GetCustomPropertyValue(
    uint in_ObjectID,
    uint in_uPropID,
    out int out_iValue)
  {
  ...
  public static uint StdChannelIndexToDisplayIndex(
    AkChannelOrdering in_eOrdering,
    uint in_uChannelMask,
    uint in_uChannelIdx)
  {
  ...
  {
    get => AkSoundEnginePINVOKE.CSharp_kDefaultMaxPathLength_get();
  }

  public static int g_SpatialAudioPoolId
  {
    set => AkSoundEnginePINVOKE.CSharp_g_SpatialAudioPoolId_set(value);
    get => AkSoundEnginePINVOKE.CSharp_g_SpatialAudioPoolId_get();
  }

  public static int GetPoolID() => AkSoundEnginePINVOKE.CSharp_GetPoolID();
  ...
  public static AKRESULT SetEmitterAuxSendValues(
    GameObject in_gameObjectID,
    AkAuxSendArray in_pAuxSends,
    uint in_uNumAux)
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
  ...
  public static AKRESULT SetImageSource(
    uint in_srcID,
    AkImageSourceSettings in_info,
    uint in_AuxBusID,
    ulong in_roomID,
    GameObject in_gameObjectID)
  {
  ...
  public static AKRESULT RemoveImageSource(
    uint in_srcID,
    uint in_AuxBusID,
    GameObject in_gameObjectID)
  {
  ...
  public static AKRESULT SetGeometry(
    ulong in_GeomSetID,
    AkTriangleArray in_pTriangles,
    uint in_uNumTriangles)
  {
  ...
  public static void SetAudioInputCallbacks(
    AkAudioInputManager.AudioSamplesInteropDelegate getAudioSamples,
    AkAudioInputManager.AudioFormatInteropDelegate getAudioFormat)
  {
  ...
  public static AKRESULT Init(
    ...
    AkSpatialAudioInitSettings in_pSpatialAudioSettings,
    uint in_preparePoolSizeByte)
  {
  ...
  public static AKRESULT RegisterGameObjInternal_WithName(
    GameObject in_GameObj,
    string in_pszObjName)
  {
  ...
  public static AKRESULT LoadFilePackage(
    string in_pszFilePackageName,
    out uint out_uPackageID,
    int in_memPoolID)
  {
  ...
  public static AKRESULT LoadAndDecodeBank(
    string in_pszString,
    bool in_bSaveDecodedBank,
    out uint out_bankID)
  {
    return (AKRESULT) AkSoundEnginePINVOKE.CSharp_LoadAndDecodeBank(in_pszString, in_bSaveDecodedBank, out out_bankID);
  }

  public static AKRESULT LoadAndDecodeBankFromMemory(
    IntPtr in_BankData,
    uint in_BankDataSize,
    bool in_bSaveDecodedBank,
    string in_DecodedBankName,
  ...
  public static AKRESULT SetObjectPosition(
    GameObject in_GameObjectID,
    float PosX,
    float PosY,
    float PosZ,
  ...
  public static AKRESULT GetSourceMultiplePlayPositions(
    uint in_PlayingID,
    uint[] out_audioNodeID,
    uint[] out_mediaID,
    int[] out_msTime,
    ref uint io_pcPositions,
    bool in_bExtrapolate)
  {
  ...
  public static AKRESULT SetListeners(
    GameObject in_emitterGameObj,
    ulong[] in_pListenerGameObjs,
    uint in_uNumListeners)
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(in_emitterGameObj);
    AkSoundEngine.PreGameObjectAPICall(in_emitterGameObj, akGameObjectId);
  ...
  public static AKRESULT AddOutput(
    AkOutputSettings in_Settings,
    out ulong out_pDeviceID,
    ulong[] in_pListenerIDs,
    uint in_uNumListeners)
  {
  ...
  public static uint GetMajorMinorVersion() => AkSoundEnginePINVOKE.CSharp_GetMajorMinorVersion();
  ...
  public static AKRESULT QueryIndirectPaths(
    GameObject in_gameObjectID,
    AkSoundPropagationPathParams arg1,
    AkSoundPathInfoArray paths,
    uint numPaths)
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
  ...
  public static AKRESULT QuerySoundPropagationPaths(
    GameObject in_gameObjectID,
    AkSoundPropagationPathParams arg1,
    AkPropagationPathInfoArray paths,
    uint numPaths)
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(in_gameObjectID);
    AkSoundEngine.PreGameObjectAPICall(in_gameObjectID, akGameObjectId);
  ...
  public static AKRESULT SetRoomPortal(
    ulong in_PortalID,
  ...
  public static string StringFromIntPtrString(IntPtr ptr) => Marshal.PtrToStringAnsi(ptr);

  public static string StringFromIntPtrWString(IntPtr ptr) => Marshal.PtrToStringUni(ptr);
  ...
  {
    return (UnityEngine.Object) gameObject == (UnityEngine.Object) null ? ulong.MaxValue : (ulong) gameObject.GetInstanceID();
  }
  ...
  public static AkSoundEngine.GameObjectHashFunction GameObjectHash
  {
    set
    {
      ...
      AkSoundEngine.gameObjectHash = objectHashFunction;
    }
  }
  ...
  public static AKRESULT RegisterGameObj(GameObject gameObject)
  {
    ...
    AKRESULT result = (AKRESULT) AkSoundEnginePINVOKE.CSharp_RegisterGameObjInternal(akGameObjectId);
    AkSoundEngine.PostRegisterGameObjUserHook(result, gameObject, akGameObjectId);
    return result;
  }
  ...
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(gameObject);
    AKRESULT result = (AKRESULT) AkSoundEnginePINVOKE.CSharp_RegisterGameObjInternal_WithName(akGameObjectId, name);
    AkSoundEngine.PostRegisterGameObjUserHook(result, gameObject, akGameObjectId);
    return result;
  }
  ...
  {
    ulong akGameObjectId = AkSoundEngine.GetAkGameObjectID(gameObject);
    AKRESULT result = (AKRESULT) AkSoundEnginePINVOKE.CSharp_UnregisterGameObjInternal(akGameObjectId);
    AkSoundEngine.PostUnregisterGameObjUserHook(result, gameObject, akGameObjectId);
    return result;
  }

  public static AKRESULT SetObjectPosition(GameObject gameObject, Transform transform)
  {
    return (AKRESULT) AkSoundEnginePINVOKE.CSharp_SetObjectPosition(AkSoundEngine.GetAkGameObjectID(gameObject), transform.position.x, transform.position.y, transform.position.z, transform.forward.x, transform.forward.y, transform.forward.z, transform.up.x, transform.up.y, transform.up.z);
  }
  ...
  public static AKRESULT SetObjectPosition(
    ...
    Vector3 up)
  {
    return (AKRESULT) AkSoundEnginePINVOKE.CSharp_SetObjectPosition(AkSoundEngine.GetAkGameObjectID(gameObject), position.x, position.y, position.z, forward.x, forward.y, forward.z, up.x, up.y, up.z);
  }
  ...
  private static void AutoRegister(GameObject gameObject, ulong id)
  {
    ...
    {
      AkSoundEngine.AutoObject autoObject = new AkSoundEngine.AutoObject(gameObject);
    }
    else
    {
      if (!((UnityEngine.Object) gameObject.GetComponent<AkGameObj>() == (UnityEngine.Object) null))
        return;
  ...
  private static void PostUnregisterGameObjUserHook(
    AKRESULT result,
    GameObject gameObject,
    ulong id)
  {
  ...
  private class AutoObject
  {
    ...
    {
      this.gameObject = go;
      int num = (int) AkSoundEngine.RegisterGameObj(this.gameObject, !((UnityEngine.Object) this.gameObject != (UnityEngine.Object) null) ? "AkAutoObject" : "AkAutoObject for " + this.gameObject.name);
    }
