...
// Type: HutongGames.PlayMaker.Actions.iTweenRotateFrom
...
[HutongGames.PlayMaker.Tooltip("Instantly changes a GameObject's Euler angles in degrees then returns it to it's starting rotation over time.")]
...
public class iTweenRotateFrom : iTweenFsmAction
{
  ...
  public FsmString id;
  [HutongGames.PlayMaker.Tooltip("A rotation from a GameObject.")]
  public FsmGameObject transformRotation;
  [HutongGames.PlayMaker.Tooltip("A rotation vector the GameObject will animate from.")]
  ...
  private void DoiTween()
  {
    ...
    if ((Object) ownerDefaultTarget == (Object) null)
      return;
    Vector3 vector3 = !this.vectorRotation.IsNone ? this.vectorRotation.Value : Vector3.zero;
    if (!this.transformRotation.IsNone && (bool) (Object) this.transformRotation.Value)
      vector3 = this.space != Space.World ? this.transformRotation.Value.transform.localEulerAngles + vector3 : this.transformRotation.Value.transform.eulerAngles + vector3;
    this.itweenType = "rotate";
    iTween.RotateFrom(ownerDefaultTarget, iTween.Hash((object) "rotation", (object) vector3, (object) "name", !this.id.IsNone ? (object) this.id.Value : (object) string.Empty, !this.speed.IsNone ? (object) "speed" : (object) "time", (object) (float) (!this.speed.IsNone ? (double) this.speed.Value : (!this.time.IsNone ? (double) this.time.Value : 1.0)), (object) "delay", (object) (float) (!this.delay.IsNone ? (double) this.delay.Value : 0.0), (object) "easetype", (object) this.easeType, (object) "looptype", (object) this.loopType, (object) "oncomplete", (object) "iTweenOnComplete", (object) "oncompleteparams", (object) this.itweenID, (object) "onstart", (object) "iTweenOnStart", (object) "onstartparams", (object) this.itweenID, (object) "ignoretimescale", (object) (bool) (!this.realTime.IsNone ? (this.realTime.Value ? 1 : 0) : 0), (object) "islocal", (object) (this.space == Space.Self)));
  }
}
