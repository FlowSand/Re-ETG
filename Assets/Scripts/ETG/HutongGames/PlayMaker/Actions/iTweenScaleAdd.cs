...
// Type: HutongGames.PlayMaker.Actions.iTweenScaleAdd
...
{
  [HutongGames.PlayMaker.Tooltip("Adds to a GameObject's scale over time.")]
  ...
  public class iTweenScaleAdd : iTweenFsmAction
  {
    ...
    public FsmString id;
    [HutongGames.PlayMaker.Tooltip("A vector that will be added to the GameObjects scale.")]
    [RequiredField]
