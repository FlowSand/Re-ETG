...
public class StartCoroutine : FsmStateAction
{
  ...
  private void DoStartCoroutine()
  {
    ...
    else
    {
      ...
      if (HutongGames.PlayMaker.Actions.StartCoroutine._f__switch_map2 == null)
      {
        // ISSUE: reference to a compiler-generated field
        HutongGames.PlayMaker.Actions.StartCoroutine._f__switch_map2 = new Dictionary<string, int>(13)
        {
          {
            "None",
            0
      ...
      int num;
      // ISSUE: reference to a compiler-generated field
      if (!HutongGames.PlayMaker.Actions.StartCoroutine._f__switch_map2.TryGetValue(parameterType, out num))
        return;
      switch (num)
      {
        case 0:
