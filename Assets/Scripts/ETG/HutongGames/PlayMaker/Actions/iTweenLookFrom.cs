...
// Type: HutongGames.PlayMaker.Actions.iTweenLookFrom
...
namespace HutongGames.PlayMaker.Actions
{
  ...
  [HutongGames.PlayMaker.Tooltip("Instantly rotates a GameObject to look at the supplied Vector3 then returns it to it's starting rotation over time.")]
  public class iTweenLookFrom : iTweenFsmAction
  {
    ...
    public FsmString id;
    [HutongGames.PlayMaker.Tooltip("Look from a transform position.")]
