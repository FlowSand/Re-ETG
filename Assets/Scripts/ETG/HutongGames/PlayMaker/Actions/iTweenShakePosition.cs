...
// Type: HutongGames.PlayMaker.Actions.iTweenShakePosition
...
{
  [HutongGames.PlayMaker.Tooltip("Randomly shakes a GameObject's position by a diminishing amount over time.")]
  ...
  public class iTweenShakePosition : iTweenFsmAction
  {
    ...
    public FsmString id;
    [HutongGames.PlayMaker.Tooltip("A vector shake range.")]
    [RequiredField]
