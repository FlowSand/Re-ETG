...
namespace SimplexNoise
{
    public class Noise
    {
        ...
        public static float Generate(float x)
        {
            ...
            float x2 = x1 - 1f;
            float num3 = (float) (1.0 - (double) x1 * (double) x1);
            float num4 = num3 * num3;
            float num5 = num4 * num4 * Noise.grad((int) Noise.perm[num1 & (int) byte.MaxValue], x1);
            float num6 = (float) (1.0 - (double) x2 * (double) x2);
            float num7 = num6 * num6;
            float num8 = num7 * num7 * Noise.grad((int) Noise.perm[num2 & (int) byte.MaxValue], x2);
        ...
        private static int FastFloor(float x) => (double) x > 0.0 ? (int) x : (int) x - 1;
        ...
        {
            int num1 = hash & 7;
            float num2 = num1 >= 4 ? y : x;
            float num3 = num1 >= 4 ? x : y;
        ...
        {
            int num1 = hash & 15;
            float num2 = num1 >= 8 ? y : x;
            float num3 = num1 >= 4 ? (num1 == 12 || num1 == 14 ? x : z) : y;
