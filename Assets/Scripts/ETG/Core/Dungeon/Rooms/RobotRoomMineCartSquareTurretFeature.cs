...
// Type: RobotRoomMineCartSquareTurretFeature
...
namespace ETG.Core.Dungeon.Rooms
{
    public class RobotRoomMineCartSquareTurretFeature : RobotRoomFeature
    {
        ...
        int targetObjectLayer)
      {
        ...
        this.PlaceObject(RobotDave.GetMineCartTurretPrefab(), room, intVector2, targetObjectLayer).assignedPathIDx = room.paths.Count - 1;
      }
    }
