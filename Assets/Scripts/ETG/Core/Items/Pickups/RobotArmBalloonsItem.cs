    ...
    public class RobotArmBalloonsItem : PickupObject
    {
      ...
      public void RegisterMinimapIcon()
      {
        ...
        if ((Object) this.minimapIcon == (Object) null)
          this.minimapIcon = (GameObject) BraveResources.Load("Global Prefabs/Minimap_RobotBalloon_Icon");
      ...
      public bool CheckForCombination()
      {
        for (int index1 = 0; index1 < GameManager.Instance.AllPlayers.Length; ++index1)
        {
          ...
          {
            if (GameManager.Instance.AllPlayers[index1].additionalItems[index2] is RobotArmItem)
            {
              RobotArmQuestController.CombineBalloonsWithArm((PickupObject) this, GameManager.Instance.AllPlayers[index1].additionalItems[index2], GameManager.Instance.AllPlayers[index1]);
              return true;
            }
          }
        }
      ...
      {
        Object.Instantiate<GameObject>(this.BalloonAttachPrefab.gameObject).GetComponent<BalloonAttachmentDoer>().Initialize(target);
      }
      ...
      public override void Pickup(PlayerController player)
      {
        ...
        this.AttachBalloonToGameActor((GameActor) player);
