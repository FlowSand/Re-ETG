    ...
    public class MachoBraceItem : PassiveItem
    {
      ...
      private void HandleProjectileFired(Projectile firedProjectile, float arg2)
      {
        ...
        if (this.m_hasUsedShot)
          return;
        this.m_hasUsedShot = true;
        if ((bool) (UnityEngine.Object) this.Owner && (bool) (UnityEngine.Object) this.DustUpVFX)
        {
          this.Owner.PlayEffectOnActor(this.DustUpVFX, new Vector3(0.0f, -0.625f, 0.0f), false);
          int num = (int) AkSoundEngine.PostEvent("Play_ITM_Macho_Brace_Trigger_01", this.gameObject);
        }
        if (!(bool) (UnityEngine.Object) this.Owner || !(bool) (UnityEngine.Object) this.BurstVFX)
          return;
        this.Owner.PlayEffectOnActor(this.BurstVFX, new Vector3(0.0f, 0.375f, 0.0f), false);
      }
      ...
      private IEnumerator HandleDamageBoost(PlayerController target)
      {
        ...
        return (IEnumerator) new MachoBraceItem__HandleDamageBoostc__Iterator0()
        {
          target = target,
          _this = this
        };
