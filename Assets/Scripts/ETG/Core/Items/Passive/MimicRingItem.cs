...
public class MimicRingItem : PassiveItem
  {
    public override void Pickup(PlayerController player)
    {
      ...
      {
        if ((bool) (UnityEngine.Object) StaticReferenceManager.AllChests[index] && !StaticReferenceManager.AllChests[index].IsOpen)
          StaticReferenceManager.AllChests[index].MaybeBecomeMimic();
      }
      base.Pickup(player);
    }
