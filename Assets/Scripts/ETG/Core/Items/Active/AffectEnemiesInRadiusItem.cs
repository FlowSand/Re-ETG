...
[DebuggerHidden]
    protected IEnumerator HandleAmbientSpawnTime(Vector2 centerPoint, float remainingTime)
    {
      ...
      return (IEnumerator) new AffectEnemiesInRadiusItem__HandleAmbientSpawnTimec__Iterator0()
      {
...
[DebuggerHidden]
    ...
    {
      // ISSUE: object of a compiler-generated type is created
      return (IEnumerator) new AffectEnemiesInRadiusItem__ProcessEffectOverTimec__Iterator1()
      {
