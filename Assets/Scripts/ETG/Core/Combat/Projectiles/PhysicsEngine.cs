...
public class PhysicsEngine : MonoBehaviour
    {
            ...
            ref CollisionData nearestCollision)
        {
            ...
            if (PhysicsEngine._f__mg_cache0 == null)
            {
                // ISSUE: reference to a compiler-generated field
                PhysicsEngine._f__mg_cache0 = new Func<SpeculativeRigidbody, bool>(PhysicsEngine.CollideWithRigidbodiesQuery);
            }
            // ISSUE: reference to a compiler-generated field
            Func<SpeculativeRigidbody, bool> fMgCache0 = PhysicsEngine._f__mg_cache0;
            ...
            if (this.CollidesWithProjectiles(rigidbody))
            {
                ...
                b2AABB aabb2 = b2Aabb;
                // ISSUE: reference to a compiler-generated field
                if (PhysicsEngine._f__mg_cache1 == null)
                {
                    // ISSUE: reference to a compiler-generated field
                    PhysicsEngine._f__mg_cache1 = new Func<SpeculativeRigidbody, bool>(PhysicsEngine.CollideWithRigidbodiesQuery);
                }
                // ISSUE: reference to a compiler-generated field
                Func<SpeculativeRigidbody, bool> fMgCache1 = PhysicsEngine._f__mg_cache1;
