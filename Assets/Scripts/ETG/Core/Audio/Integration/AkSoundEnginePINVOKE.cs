...
internal class AkSoundEnginePINVOKE
  {
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkExternalSourceInfo_iExternalSrcCookie_set(
      IntPtr jarg1,
      uint jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern IntPtr CSharp_new_AkExternalSourceInfo__SWIG_1(
      IntPtr jarg1,
      uint jarg2,
      uint jarg3,
      uint jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern IntPtr CSharp_new_AkExternalSourceInfo__SWIG_2(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      uint jarg2,
      uint jarg3);

    [DllImport("AkSoundEngine")]
    public static extern IntPtr CSharp_new_AkExternalSourceInfo__SWIG_3(
      uint jarg1,
      uint jarg2,
      uint jarg3);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkTransform_Set__SWIG_0(
      IntPtr jarg1,
      IntPtr jarg2,
      IntPtr jarg3,
      IntPtr jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkTransform_Set__SWIG_1(
      IntPtr jarg1,
      float jarg2,
      float jarg3,
      float jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkTransform_SetOrientation__SWIG_1(
      IntPtr jarg1,
      float jarg2,
      float jarg3,
      float jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkObstructionOcclusionValues_occlusion_set(
      IntPtr jarg1,
      float jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkObstructionOcclusionValues_obstruction_set(
      IntPtr jarg1,
      float jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkAuxSendValue_Set(
      IntPtr jarg1,
      ulong jarg2,
      uint jarg3,
      float jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_AkAuxSendValue_SetGameObjectAuxSendValues(
      IntPtr jarg1,
      ulong jarg2,
      uint jarg3);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_AkAuxSendValue_GetGameObjectAuxSendValues(
      IntPtr jarg1,
      ulong jarg2,
      ref uint jarg3);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkAudioFormat_SetAll(
      IntPtr jarg1,
      uint jarg2,
      IntPtr jarg3,
      uint jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_AkPlaylistItem_SetExternalSources(
      IntPtr jarg1,
      uint jarg2,
      IntPtr jarg3);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_AkPlaylist_Enqueue__SWIG_0(
      IntPtr jarg1,
      uint jarg2,
      int jarg3,
      IntPtr jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_AkPlaylist_Enqueue__SWIG_1(
      IntPtr jarg1,
      uint jarg2,
      int jarg3,
      IntPtr jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_AkPlaylist_Enqueue__SWIG_2(
      IntPtr jarg1,
      uint jarg2,
      int jarg3,
      IntPtr jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern uint CSharp_DynamicSequenceOpen__SWIG_1(
      ulong jarg1,
      uint jarg2,
      IntPtr jarg3,
      IntPtr jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_DynamicSequenceGetPauseTimes(
      uint jarg1,
      out uint jarg2,
      out uint jarg3);
    ...
    [DllImport("AkSoundEngine")]
    public static extern IntPtr CSharp_new_AkOutputSettings__SWIG_1(
      [MarshalAs(UnmanagedType.LPStr)] string jarg1,
      uint jarg2,
      IntPtr jarg3,
      int jarg4);

    [DllImport("AkSoundEngine")]
    public static extern IntPtr CSharp_new_AkOutputSettings__SWIG_2(
      [MarshalAs(UnmanagedType.LPStr)] string jarg1,
      uint jarg2,
      IntPtr jarg3);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkOutputSettings_audioDeviceShareset_set(
      IntPtr jarg1,
      uint jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkInitSettings_fDefaultPoolRatioThreshold_set(
      IntPtr jarg1,
      float jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkInitSettings_uPrepareEventMemoryPoolID_set(
      IntPtr jarg1,
      int jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkInitSettings_uMonitorQueuePoolSize_set(
      IntPtr jarg1,
      uint jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkInitSettings_uMaxHardwareTimeoutMs_set(
      IntPtr jarg1,
      uint jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkInitSettings_bUseSoundBankMgrThread_set(
      IntPtr jarg1,
      bool jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkAudioSettings_uNumSamplesPerSecond_set(
      IntPtr jarg1,
      uint jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_GetSpeakerAngles__SWIG_0(
      [MarshalAs(UnmanagedType.LPArray), In, Out] float[] jarg1,
      ref uint jarg2,
      out float jarg3,
      ulong jarg4);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_GetSpeakerAngles__SWIG_1(
      [MarshalAs(UnmanagedType.LPArray), In, Out] float[] jarg1,
      ref uint jarg2,
      out float jarg3);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetSpeakerAngles__SWIG_0(
      [MarshalAs(UnmanagedType.LPArray), In] float[] jarg1,
      uint jarg2,
      float jarg3,
      ulong jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern uint CSharp_PostEvent__SWIG_0(
      uint jarg1,
      ulong jarg2,
      uint jarg3,
      IntPtr jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern uint CSharp_PostEvent__SWIG_1(
      uint jarg1,
      ulong jarg2,
      uint jarg3,
      IntPtr jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern uint CSharp_PostEvent__SWIG_2(
      uint jarg1,
      ulong jarg2,
      uint jarg3,
      IntPtr jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern uint CSharp_PostEvent__SWIG_3(
      uint jarg1,
      ulong jarg2,
      uint jarg3,
      IntPtr jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern uint CSharp_PostEvent__SWIG_6(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      ulong jarg2,
      uint jarg3,
      IntPtr jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern uint CSharp_PostEvent__SWIG_7(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      ulong jarg2,
      uint jarg3,
      IntPtr jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern uint CSharp_PostEvent__SWIG_8(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      ulong jarg2,
      uint jarg3,
      IntPtr jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern uint CSharp_PostEvent__SWIG_9(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      ulong jarg2,
      uint jarg3,
      IntPtr jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_ExecuteActionOnEvent__SWIG_0(
      uint jarg1,
      int jarg2,
      ulong jarg3,
      int jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_ExecuteActionOnEvent__SWIG_1(
      uint jarg1,
      int jarg2,
      ulong jarg3,
      int jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_ExecuteActionOnEvent__SWIG_2(
      uint jarg1,
      int jarg2,
      ulong jarg3,
      int jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_ExecuteActionOnEvent__SWIG_5(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      int jarg2,
      ulong jarg3,
      int jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_ExecuteActionOnEvent__SWIG_6(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      int jarg2,
      ulong jarg3,
      int jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_ExecuteActionOnEvent__SWIG_8(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      int jarg2,
      ulong jarg3);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_PostMIDIOnEvent(
      uint jarg1,
      ulong jarg2,
      IntPtr jarg3,
      ushort jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_PinEventInStreamCache__SWIG_1(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      char jarg2,
      char jarg3);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_GetBufferStatusForPinnedEvent__SWIG_1(
      [MarshalAs(UnmanagedType.LPStr)] string jarg1,
      out float jarg2,
      out int jarg3);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SeekOnEvent__SWIG_0(
      uint jarg1,
      ulong jarg2,
      int jarg3,
      bool jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SeekOnEvent__SWIG_1(
      uint jarg1,
      ulong jarg2,
      int jarg3,
      bool jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SeekOnEvent__SWIG_3(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      ulong jarg2,
      int jarg3,
      bool jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SeekOnEvent__SWIG_4(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      ulong jarg2,
      int jarg3,
      bool jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SeekOnEvent__SWIG_10(
      uint jarg1,
      ulong jarg2,
      float jarg3,
      bool jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SeekOnEvent__SWIG_12(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      ulong jarg2,
      float jarg3,
      bool jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SeekOnEvent__SWIG_13(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      ulong jarg2,
      float jarg3,
      bool jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_GetSourcePlayPosition__SWIG_0(
      uint jarg1,
      out int jarg2,
      bool jarg3);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_GetSourceStreamBuffering(
      uint jarg1,
      out int jarg2,
      out int jarg3);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SendPluginCustomGameData(
      uint jarg1,
      ulong jarg2,
      int jarg3,
      uint jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetMultiplePositions__SWIG_0(
      ulong jarg1,
      IntPtr jarg2,
      ushort jarg3,
      int jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetMultiplePositions__SWIG_2(
      ulong jarg1,
      IntPtr jarg2,
      ushort jarg3,
      int jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetMultiplePositions__SWIG_3(
      ulong jarg1,
      IntPtr jarg2,
      ushort jarg3);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_LoadBank__SWIG_3(
      IntPtr jarg1,
      uint jarg2,
      int jarg3,
      out uint jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_LoadBank__SWIG_4(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      IntPtr jarg2,
      IntPtr jarg3,
      int jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_LoadBank__SWIG_5(
      uint jarg1,
      IntPtr jarg2,
      IntPtr jarg3,
      int jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_LoadBank__SWIG_6(
      IntPtr jarg1,
      uint jarg2,
      IntPtr jarg3,
      IntPtr jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_UnloadBank__SWIG_6(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      IntPtr jarg2,
      IntPtr jarg3,
      IntPtr jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_UnloadBank__SWIG_8(
      uint jarg1,
      IntPtr jarg2,
      IntPtr jarg3,
      IntPtr jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_PrepareBank__SWIG_6(
      int jarg1,
      [MarshalAs(UnmanagedType.LPWStr)] string jarg2,
      IntPtr jarg3,
      IntPtr jarg4,
      int jarg5);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_PrepareBank__SWIG_7(
      int jarg1,
      [MarshalAs(UnmanagedType.LPWStr)] string jarg2,
      IntPtr jarg3,
      IntPtr jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_PrepareBank__SWIG_10(
      int jarg1,
      uint jarg2,
      IntPtr jarg3,
      IntPtr jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_PrepareBank__SWIG_11(
      int jarg1,
      uint jarg2,
      IntPtr jarg3,
      IntPtr jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_PrepareEvent__SWIG_3(
      int jarg1,
      [MarshalAs(UnmanagedType.LPArray), In] uint[] jarg2,
      uint jarg3,
      IntPtr jarg4,
      IntPtr jarg5);
    ...
    public static extern int CSharp_PrepareGameSyncs__SWIG_0(
      int jarg1,
      int jarg2,
      [MarshalAs(UnmanagedType.LPWStr)] string jarg3,
      IntPtr jarg4,
      uint jarg5);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_PrepareGameSyncs__SWIG_1(
      int jarg1,
      int jarg2,
      uint jarg3,
      [MarshalAs(UnmanagedType.LPArray), In] uint[] jarg4,
      uint jarg5);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_PrepareGameSyncs__SWIG_2(
      int jarg1,
      int jarg2,
      [MarshalAs(UnmanagedType.LPWStr)] string jarg3,
      IntPtr jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_PrepareGameSyncs__SWIG_3(
      int jarg1,
      int jarg2,
      uint jarg3,
      [MarshalAs(UnmanagedType.LPArray), In] uint[] jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetListenerSpatialization__SWIG_0(
      ulong jarg1,
      bool jarg2,
      IntPtr jarg3,
      [MarshalAs(UnmanagedType.LPArray), In] float[] jarg4);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetListenerSpatialization__SWIG_1(
      ulong jarg1,
      bool jarg2,
      IntPtr jarg3);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetRTPCValue__SWIG_0(
      uint jarg1,
      float jarg2,
      ulong jarg3,
      int jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetRTPCValue__SWIG_1(
      uint jarg1,
      float jarg2,
      ulong jarg3,
      int jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetRTPCValue__SWIG_2(
      uint jarg1,
      float jarg2,
      ulong jarg3,
      int jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetRTPCValue__SWIG_5(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      float jarg2,
      ulong jarg3,
      int jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetRTPCValue__SWIG_7(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      float jarg2,
      ulong jarg3,
      int jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetRTPCValueByPlayingID__SWIG_0(
      uint jarg1,
      float jarg2,
      uint jarg3,
      int jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetRTPCValueByPlayingID__SWIG_1(
      uint jarg1,
      float jarg2,
      uint jarg3,
      int jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetRTPCValueByPlayingID__SWIG_2(
      uint jarg1,
      float jarg2,
      uint jarg3,
      int jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetRTPCValueByPlayingID__SWIG_3(
      uint jarg1,
      float jarg2,
      uint jarg3);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetRTPCValueByPlayingID__SWIG_4(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      float jarg2,
      uint jarg3,
      int jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetRTPCValueByPlayingID__SWIG_5(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      float jarg2,
      uint jarg3,
      int jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetRTPCValueByPlayingID__SWIG_6(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      float jarg2,
      uint jarg3,
      int jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetRTPCValueByPlayingID__SWIG_7(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      float jarg2,
      uint jarg3);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_ResetRTPCValue__SWIG_0(
      uint jarg1,
      ulong jarg2,
      int jarg3,
      int jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_ResetRTPCValue__SWIG_1(
      uint jarg1,
      ulong jarg2,
      int jarg3,
      int jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_ResetRTPCValue__SWIG_5(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      ulong jarg2,
      int jarg3,
      int jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetGameObjectOutputBusVolume(
      ulong jarg1,
      ulong jarg2,
      float jarg3);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetObjectObstructionAndOcclusion(
      ulong jarg1,
      ulong jarg2,
      float jarg3,
      float jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetMultipleObstructionAndOcclusion(
      ulong jarg1,
      ulong jarg2,
      IntPtr jarg3,
      uint jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkMIDIEvent_tProgramChange_byProgramNum_set(
      IntPtr jarg1,
      byte jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_AkMIDIPost_PostOnEvent(
      IntPtr jarg1,
      uint jarg2,
      ulong jarg3,
      uint jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkMusicSettings_fStreamingLookAheadRatio_set(
      IntPtr jarg1,
      float jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_GetPlayingSegmentInfo__SWIG_0(
      uint jarg1,
      IntPtr jarg2,
      bool jarg3);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_AkMusicSyncCallbackInfo_segmentInfo_iCurrentPosition_get(
      IntPtr jarg1);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_AkMusicSyncCallbackInfo_segmentInfo_iPreEntryDuration_get(
      IntPtr jarg1);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_AkMusicSyncCallbackInfo_segmentInfo_iActiveDuration_get(
      IntPtr jarg1);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_AkMusicSyncCallbackInfo_segmentInfo_iRemainingLookAheadTime_get(
      IntPtr jarg1);

    [DllImport("AkSoundEngine")]
    public static extern float CSharp_AkMusicSyncCallbackInfo_segmentInfo_fBeatDuration_get(
      IntPtr jarg1);

    [DllImport("AkSoundEngine")]
    public static extern float CSharp_AkMusicSyncCallbackInfo_segmentInfo_fBarDuration_get(
      IntPtr jarg1);
    ...
    [DllImport("AkSoundEngine")]
    public static extern bool CSharp_AkAudioInterruptionCallbackInfo_bEnterInterruption_get(
      IntPtr jarg1);
    ...
    [DllImport("AkSoundEngine")]
    public static extern bool CSharp_AkAudioSourceChangeCallbackInfo_bOtherAudioPlaying_get(
      IntPtr jarg1);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_AkCallbackSerializer_AudioSourceChangeCallbackFunc(
      bool jarg1,
      IntPtr jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_PostCode__SWIG_0(
      int jarg1,
      int jarg2,
      uint jarg3,
      ulong jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_PostCode__SWIG_1(
      int jarg1,
      int jarg2,
      uint jarg3,
      ulong jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_PostString__SWIG_0(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      int jarg2,
      uint jarg3,
      ulong jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_PostString__SWIG_1(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      int jarg2,
      uint jarg3,
      ulong jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_PostString__SWIG_2(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      int jarg2,
      uint jarg3,
      ulong jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern uint CSharp_ResolveDialogueEvent__SWIG_0(
      uint jarg1,
      [MarshalAs(UnmanagedType.LPArray), In] uint[] jarg2,
      uint jarg3,
      uint jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern uint CSharp_ResolveDialogueEvent__SWIG_1(
      uint jarg1,
      [MarshalAs(UnmanagedType.LPArray), In] uint[] jarg2,
      uint jarg3);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_GetDialogueEventCustomPropertyValue__SWIG_0(
      uint jarg1,
      uint jarg2,
      out int jarg3);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_GetDialogueEventCustomPropertyValue__SWIG_1(
      uint jarg1,
      uint jarg2,
      out float jarg3);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkPositioningInfo_bUseConeAttenuation_set(
      IntPtr jarg1,
      bool jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkPositioningInfo_fConeMaxAttenuation_set(
      IntPtr jarg1,
      float jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkPositioningInfo_fVolAuxGameDefAtMaxDist_set(
      IntPtr jarg1,
      float jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkPositioningInfo_fVolAuxUserDefAtMaxDist_set(
      IntPtr jarg1,
      float jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkPositioningInfo_LPFValueAtMaxDist_set(
      IntPtr jarg1,
      float jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkPositioningInfo_HPFValueAtMaxDist_set(
      IntPtr jarg1,
      float jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_GetRTPCValue__SWIG_0(
      uint jarg1,
      ulong jarg2,
      uint jarg3,
      out float jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_GetRTPCValue__SWIG_1(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      ulong jarg2,
      uint jarg3,
      out float jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_GetGameObjectAuxSendValues(
      ulong jarg1,
      IntPtr jarg2,
      ref uint jarg3);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_GetGameObjectDryLevelValue(
      ulong jarg1,
      ulong jarg2,
      out float jarg3);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_GetObjectObstructionAndOcclusion(
      ulong jarg1,
      ulong jarg2,
      out float jarg3,
      out float jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_QueryAudioObjectIDs__SWIG_0(
      uint jarg1,
      ref uint jarg2,
      IntPtr jarg3);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_QueryAudioObjectIDs__SWIG_1(
      [MarshalAs(UnmanagedType.LPWStr)] string jarg1,
      ref uint jarg2,
      IntPtr jarg3);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_GetPlayingIDsFromGameObject(
      ulong jarg1,
      ref uint jarg2,
      [MarshalAs(UnmanagedType.LPArray), Out] uint[] jarg3);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_GetCustomPropertyValue__SWIG_0(
      uint jarg1,
      uint jarg2,
      out int jarg3);

    [DllImport("AkSoundEngine")]
    public static extern int CSharp_GetCustomPropertyValue__SWIG_1(
      uint jarg1,
      uint jarg2,
      out float jarg3);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkChannelConfig_SetStandardOrAnonymous(
      IntPtr jarg1,
      uint jarg2,
      uint jarg3);
    ...
    [DllImport("AkSoundEngine")]
    public static extern IntPtr CSharp_new_AkImageSourceParams__SWIG_1(
      IntPtr jarg1,
      float jarg2,
      float jarg3);

    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkImageSourceParams_sourcePosition_set(
      IntPtr jarg1,
      IntPtr jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkSpatialAudioInitSettings_uPoolSize_set(
      IntPtr jarg1,
      uint jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkSpatialAudioInitSettings_uMaxSoundPropagationDepth_set(
      IntPtr jarg1,
      uint jarg2);

    [DllImport("AkSoundEngine")]
    public static extern uint CSharp_AkSpatialAudioInitSettings_uMaxSoundPropagationDepth_get(
      IntPtr jarg1);

    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkSpatialAudioInitSettings_uDiffractionFlags_set(
      IntPtr jarg1,
      uint jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkSpatialAudioInitSettings_fDiffractionShadowAttenFactor_set(
      IntPtr jarg1,
      float jarg2);

    [DllImport("AkSoundEngine")]
    public static extern float CSharp_AkSpatialAudioInitSettings_fDiffractionShadowAttenFactor_get(
      IntPtr jarg1);
    ...
    [DllImport("AkSoundEngine")]
    public static extern float CSharp_AkSpatialAudioInitSettings_fDiffractionShadowDegrees_get(
      IntPtr jarg1);
    ...
    [DllImport("AkSoundEngine")]
    public static extern IntPtr CSharp_new_AkImageSourceSettings__SWIG_1(
      IntPtr jarg1,
      float jarg2,
      float jarg3);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkEmitterSettings_reflectorFilterMask_set(
      IntPtr jarg1,
      uint jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkEmitterSettings_roomReverbAuxBusGain_set(
      IntPtr jarg1,
      float jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkPropagationPathInfo_dryDiffractionAngle_set(
      IntPtr jarg1,
      float jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkPropagationPathInfo_wetDiffractionAngle_set(
      IntPtr jarg1,
      float jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkRoomParams_RoomGameObj_AuxSendLevelToSelf_set(
      IntPtr jarg1,
      float jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkRoomParams_RoomGameObj_KeepRegistered_set(
      IntPtr jarg1,
      bool jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetImageSource__SWIG_0(
      uint jarg1,
      IntPtr jarg2,
      uint jarg3,
      ulong jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetImageSource__SWIG_1(
      uint jarg1,
      IntPtr jarg2,
      uint jarg3,
      ulong jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkPlatformInitSettings_uLEngineDefaultPoolSize_set(
      IntPtr jarg1,
      uint jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkPlatformInitSettings_fLEngineDefaultPoolRatioThreshold_set(
      IntPtr jarg1,
      float jarg2);

    [DllImport("AkSoundEngine")]
    public static extern float CSharp_AkPlatformInitSettings_fLEngineDefaultPoolRatioThreshold_get(
      IntPtr jarg1);

    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkPlatformInitSettings_uNumRefillsInVoice_set(
      IntPtr jarg1,
      ushort jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkDeviceSettings_uSchedulerTypeFlags_set(
      IntPtr jarg1,
      uint jarg2);
    ...
    public static extern void CSharp_SetAudioInputCallbacks(
      AkAudioInputManager.AudioSamplesInteropDelegate jarg1,
      AkAudioInputManager.AudioFormatInteropDelegate jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern IntPtr CSharp_AkSoundPathInfoProxy_GetReflectionPoint(
      IntPtr jarg1,
      uint jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern IntPtr CSharp_AkPropagationPathInfoProxy_GetNodePoint(
      IntPtr jarg1,
      uint jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkSoundPropagationPathParams_listenerPos_set(
      IntPtr jarg1,
      IntPtr jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkSoundPropagationPathParams_emitterPos_set(
      IntPtr jarg1,
      IntPtr jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern void CSharp_AkSoundPropagationPathParams_numValidPaths_set(
      IntPtr jarg1,
      uint jarg2);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_Init(
      IntPtr jarg1,
      IntPtr jarg2,
      IntPtr jarg3,
      IntPtr jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_LoadAndDecodeBankFromMemory(
      IntPtr jarg1,
      uint jarg2,
      bool jarg3,
      [MarshalAs(UnmanagedType.LPWStr)] string jarg4,
      bool jarg5,
      out uint jarg6);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetObjectPosition(
      ulong jarg1,
      float jarg2,
      float jarg3,
      float jarg4,
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_GetSourceMultiplePlayPositions(
      uint jarg1,
      [MarshalAs(UnmanagedType.LPArray), Out] uint[] jarg2,
      [MarshalAs(UnmanagedType.LPArray), Out] uint[] jarg3,
      [MarshalAs(UnmanagedType.LPArray), Out] int[] jarg4,
      ref uint jarg5,
      bool jarg6);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_AddOutput(
      IntPtr jarg1,
      out ulong jarg2,
      ulong[] jarg3,
      uint jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_QueryIndirectPaths(
      ulong jarg1,
      IntPtr jarg2,
      IntPtr jarg3,
      uint jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_QuerySoundPropagationPaths(
      ulong jarg1,
      IntPtr jarg2,
      IntPtr jarg3,
      uint jarg4);
    ...
    [DllImport("AkSoundEngine")]
    public static extern int CSharp_SetRoomPortal(
      ulong jarg1,
      IntPtr jarg2,
      IntPtr jarg3,
      bool jarg4,
