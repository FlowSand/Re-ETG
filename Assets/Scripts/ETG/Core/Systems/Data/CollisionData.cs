...
public class CollisionData : CastResult
    {
        ...
        static CollisionData()
        {
            ...
            if (CollisionData._f__mg_cache0 == null)
            {
                // ISSUE: reference to a compiler-generated field
                CollisionData._f__mg_cache0 = new ObjectPool<CollisionData>.Cleanup(CollisionData.Cleanup);
            }
            // ISSUE: reference to a compiler-generated field
            ObjectPool<CollisionData>.Cleanup fMgCache0 = CollisionData._f__mg_cache0;
