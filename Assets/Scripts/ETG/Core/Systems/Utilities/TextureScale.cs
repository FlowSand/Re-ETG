        ...
        private static void ThreadedScale(Texture2D tex, int newWidth, int newHeight, bool useBilinear)
        {
            ...
            if (num1 > 1)
            {
                ...
                for (num3 = 0; num3 < num1 - 1; ++num3)
                {
                    ...
                    new Thread(!useBilinear ? new ParameterizedThreadStart(TextureScale.PointScale) : new ParameterizedThreadStart(TextureScale.BilinearScale)).Start((object) parameter);
                }
