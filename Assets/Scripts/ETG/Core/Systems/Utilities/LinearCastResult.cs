...
public class LinearCastResult : CastResult
  {
    ...
    static LinearCastResult()
    {
      ...
      if (LinearCastResult._f__mg_cache0 == null)
      {
        // ISSUE: reference to a compiler-generated field
        LinearCastResult._f__mg_cache0 = new ObjectPool<LinearCastResult>.Cleanup(LinearCastResult.Cleanup);
      }
      // ISSUE: reference to a compiler-generated field
      ObjectPool<LinearCastResult>.Cleanup fMgCache0 = LinearCastResult._f__mg_cache0;
