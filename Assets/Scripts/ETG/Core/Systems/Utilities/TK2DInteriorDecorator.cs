...
public class TK2DInteriorDecorator
    {
        ...
        public void PlaceLightDecoration(Dungeonator.Dungeon d, tk2dTileMap map)
        {
        ...
        protected bool IsValidPondCell(CellData cell, RoomHandler parentRoom, Dungeonator.Dungeon d)
        {
        ...
        protected bool IsValidChannelCell(CellData cell, RoomHandler parentRoom, Dungeonator.Dungeon d)
        {
        ...
        public void DigChannels(RoomHandler r, Dungeonator.Dungeon d, tk2dTileMap map)
        {
    ...
    label_14:
        ...
        public void ProcessHardcodedUpholstery(RoomHandler r, Dungeonator.Dungeon d, tk2dTileMap map)
        {
            DungeonMaterial materialDefinition = d.roomMaterialDefinitions[r.RoomVisualSubtype];
        ...
        public void UpholsterRoom(RoomHandler r, Dungeonator.Dungeon d, tk2dTileMap map)
        {
            DungeonMaterial materialDefinition = d.roomMaterialDefinitions[r.RoomVisualSubtype];
        ...
        public void HandleRoomDecorationMinimal(RoomHandler r, Dungeonator.Dungeon d, tk2dTileMap map)
        {
        ...
        public void HandleRoomDecoration(RoomHandler r, Dungeonator.Dungeon d, tk2dTileMap map)
        {
            this.roomUsedStamps.Clear();
            this.ProcessHardcodedUpholstery(r, d, map);
    ...
    label_89:
        ...
        private void DecorateCeilingCorners(RoomHandler r, Dungeonator.Dungeon d, tk2dTileMap map)
        {
    ...
    label_2:;
        ...
        private void BuildStampLookupTable(Dungeonator.Dungeon d)
        {
