...
public class BraveInput : MonoBehaviour
    {
        ...
        public class PressAction
        {
            ...
            static PressAction()
            {
                ...
                if (BraveInput.PressAction._f__mg_cache0 == null)
                {
                    // ISSUE: reference to a compiler-generated field
                    BraveInput.PressAction._f__mg_cache0 = new ObjectPool<BraveInput.PressAction>.Cleanup(BraveInput.PressAction.Cleanup);
                }
                // ISSUE: reference to a compiler-generated field
                ObjectPool<BraveInput.PressAction>.Cleanup fMgCache0 = BraveInput.PressAction._f__mg_cache0;
        ...
        public class HoldAction
        {
            ...
            static HoldAction()
            {
                ...
                // ISSUE: reference to a compiler-generated field
                if (BraveInput.HoldAction._f__mg_cache0 == null)
                {
                    // ISSUE: reference to a compiler-generated field
                    BraveInput.HoldAction._f__mg_cache0 = new ObjectPool<BraveInput.HoldAction>.Cleanup(BraveInput.HoldAction.Cleanup);
                }
                // ISSUE: reference to a compiler-generated field
                ObjectPool<BraveInput.HoldAction>.Cleanup fMgCache0 = BraveInput.HoldAction._f__mg_cache0;
