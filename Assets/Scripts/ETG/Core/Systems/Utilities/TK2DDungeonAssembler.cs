...
public class TK2DDungeonAssembler
  {
    ...
    public bool BCheck(Dungeonator.Dungeon d, int ix, int iy, int thresh)
    {
      return d.data.CheckInBounds(new IntVector2(ix, iy), 3 + thresh);
    }

    public bool BCheck(Dungeonator.Dungeon d, int ix, int iy) => this.BCheck(d, ix, iy, 0);
    ...
    public void ClearTileIndicesForCell(Dungeonator.Dungeon d, tk2dTileMap map, int ix, int iy)
    {
    ...
    public void BuildTileIndicesForCell(Dungeonator.Dungeon d, tk2dTileMap map, int ix, int iy)
    {
    ...
    private bool CheckLostWoodsCellValidity(Dungeonator.Dungeon d, IntVector2 p1, IntVector2 p2)
    {
    ...
    private void ClearAllIndices(CellData current, Dungeonator.Dungeon d, tk2dTileMap map, int ix, int iy)
    {
      for (int index = 0; index < map.Layers.Length; ++index)
    ...
    private void BuildFloorIndex(CellData current, Dungeonator.Dungeon d, tk2dTileMap map, int ix, int iy)
    {
    ...
    private void BuildDecoIndices(CellData current, Dungeonator.Dungeon d, tk2dTileMap map, int ix, int iy)
    {
    ...
    private bool IsValidJungleBorderCell(CellData current, Dungeonator.Dungeon d, int ix, int iy)
    {
    ...
    private bool IsValidJungleOcclusionCell(CellData current, Dungeonator.Dungeon d, int ix, int iy)
    {
    ...
    private void BuildCollisionIndex(CellData current, Dungeonator.Dungeon d, tk2dTileMap map, int ix, int iy)
    {
    ...
    private void BuildPitShadowIndex(CellData current, Dungeonator.Dungeon d, tk2dTileMap map, int ix, int iy)
    {
    ...
    private void BuildShadowIndex(CellData current, Dungeonator.Dungeon d, tk2dTileMap map, int ix, int iy)
    {
      if (!this.BCheck(d, ix, iy, -2))
        return;
      CellData cellData1 = d.data.cellData[ix - 1][iy];
    ...
    public void ApplySpriteStamp(int ix, int iy, SpriteStampData ssd, Dungeonator.Dungeon d, tk2dTileMap map)
    {
    ...
    private TileIndexGrid GetCeilingBorderIndexGrid(CellData current, Dungeonator.Dungeon d)
    {
      TileIndexGrid ceilingBorderGrid = d.roomMaterialDefinitions[current.cellVisualData.roomVisualTypeIndex].roomCeilingBorderGrid;
      if ((UnityEngine.Object) ceilingBorderGrid == (UnityEngine.Object) null)
        ceilingBorderGrid = d.roomMaterialDefinitions[0].roomCeilingBorderGrid;
    ...
    private bool IsCardinalBorder(CellData current, Dungeonator.Dungeon d, int ix, int iy)
    {
    ...
    private bool IsBorderCell(Dungeonator.Dungeon d, int ix, int iy)
    {
    ...
    private void HandleRatChunkOverhangs(Dungeonator.Dungeon d, int ix, int iy, tk2dTileMap map)
    {
    ...
    private void BuildBorderIndex(CellData current, Dungeonator.Dungeon d, tk2dTileMap map, int ix, int iy)
    {
    ...
    private bool IsNorthernmostColumnarFacewall(CellData current, Dungeonator.Dungeon d, int ix, int iy)
    {
    ...
    [DebuggerHidden]
    public IEnumerator ConstructTK2DDungeon(Dungeonator.Dungeon d, tk2dTileMap map)
    {
