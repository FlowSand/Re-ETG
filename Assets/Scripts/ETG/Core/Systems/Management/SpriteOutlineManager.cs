...
#nullable disable
    ...
    public static class SpriteOutlineManager
    {
            ...
            where T : tk2dBaseSprite
        {
            ...
            if (SpriteOutlineManager._f__mg_cache0 == null)
            {
                // ISSUE: reference to a compiler-generated field
                SpriteOutlineManager._f__mg_cache0 = new Action<tk2dBaseSprite>(SpriteOutlineManager.HandleSpriteChanged);
            }
            // ISSUE: reference to a compiler-generated field
            Action<tk2dBaseSprite> fMgCache0 = SpriteOutlineManager._f__mg_cache0;
            ...
            SpriteOutlineManager.OutlineType outlineType = SpriteOutlineManager.OutlineType.NORMAL)
        {
            ...
            tk2dBaseSprite tk2dBaseSprite = targetSprite;
            // ISSUE: reference to a compiler-generated field
            if (SpriteOutlineManager._f__mg_cache1 == null)
            {
                // ISSUE: reference to a compiler-generated field
                SpriteOutlineManager._f__mg_cache1 = new Action<tk2dBaseSprite>(SpriteOutlineManager.HandleSpriteChanged);
            }
            // ISSUE: reference to a compiler-generated field
            Action<tk2dBaseSprite> fMgCache1 = SpriteOutlineManager._f__mg_cache1;
            ...
            where T : tk2dBaseSprite
        {
            ...
            tk2dBaseSprite tk2dBaseSprite = targetSprite;
            // ISSUE: reference to a compiler-generated field
            if (SpriteOutlineManager._f__mg_cache2 == null)
            {
                // ISSUE: reference to a compiler-generated field
                SpriteOutlineManager._f__mg_cache2 = new Action<tk2dBaseSprite>(SpriteOutlineManager.HandleSpriteChanged);
            }
            // ISSUE: reference to a compiler-generated field
            Action<tk2dBaseSprite> fMgCache2 = SpriteOutlineManager._f__mg_cache2;
        ...
        public static void RemoveOutlineFromSprite(tk2dBaseSprite targetSprite, bool deparent = false)
        {
            ...
            tk2dBaseSprite tk2dBaseSprite = targetSprite;
            // ISSUE: reference to a compiler-generated field
            if (SpriteOutlineManager._f__mg_cache3 == null)
            {
                // ISSUE: reference to a compiler-generated field
                SpriteOutlineManager._f__mg_cache3 = new Action<tk2dBaseSprite>(SpriteOutlineManager.HandleSpriteChanged);
            }
            // ISSUE: reference to a compiler-generated field
            Action<tk2dBaseSprite> fMgCache3 = SpriteOutlineManager._f__mg_cache3;
