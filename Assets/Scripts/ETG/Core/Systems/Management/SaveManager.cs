...
#nullable disable
    ...
    public static class SaveManager
    {
        ...
        private static string secret = PrivateImplementationDetails_DE5600AD_6212_4D84_9A32_9D951E3289D1.Decrypt.DecryptLiteral(new byte[512]
        {
            (byte) 107,
            (byte) 164,
            (byte) 67,
        ...
        public static void WriteAllText(string path, string contents)
        {
            ...
            try
            {
                ...
                {
                    using (FileStream fileStream = File.Create(str1, 4096, FileOptions.WriteThrough))
            ...
            using (FileStream fileStream = File.Create(str2, 4096, FileOptions.WriteThrough))
                fileStream.Write(bytes, 0, bytes.Length);
            File.Delete(path);
            File.Move(str2, path);
        }
