...
// Type: InControl.RedSamuraiAndroidProfile
...
public class RedSamuraiAndroidProfile : UnityInputDeviceProfile
{
  ...
  {
    this.Name = "Red Samurai Wireless Controller";
    this.Meta = "Red Samurai Wireless Controller on Android";
    this.DeviceClass = InputDeviceClass.Controller;
    this.IncludePlatforms = new string[1]{ "Android" };
    this.JoystickNames = new string[1]{ "GS Gamepad" };
