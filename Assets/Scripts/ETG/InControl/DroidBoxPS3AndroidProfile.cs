...
// Type: InControl.DroidBoxPS3AndroidProfile
...
namespace InControl
{
  ...
  public class DroidBoxPS3AndroidProfile : UnityInputDeviceProfile
  {
    ...
    {
      this.Name = "DroidBOX GPD XD PlayON - PS3 Mode";
      this.Meta = "DroidBOX GPD XD PlayON - PS3 Mode on Android";
      this.DeviceClass = InputDeviceClass.Controller;
      this.IncludePlatforms = new string[1]{ "Android" };
      this.JoystickNames = new string[1]{ "PLAYSTATION(R)3" };
