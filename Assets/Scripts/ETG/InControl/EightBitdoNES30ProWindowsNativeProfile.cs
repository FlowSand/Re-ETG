...
// Type: InControl.EightBitdoNES30ProWindowsNativeProfile
...
namespace InControl
{
  ...
  public class EightBitdoNES30ProWindowsNativeProfile : NativeInputDeviceProfile
  {
    public EightBitdoNES30ProWindowsNativeProfile()
    {
      ...
      this.Meta = "8Bitdo NES30 Pro Controller on Windows";
      ...
      this.Matchers = new NativeInputDeviceMatcher[2]
      {
        new NativeInputDeviceMatcher()
        {
          ...
          ProductID = new ushort?((ushort) 36865)
        },
        new NativeInputDeviceMatcher()
        {
          VendorID = new ushort?((ushort) 11720),
          ProductID = new ushort?((ushort) 14368)
        }
      };
