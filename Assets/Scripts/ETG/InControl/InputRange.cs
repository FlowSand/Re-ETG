...
namespace InControl
{
    public struct InputRange
    {
        ...
        public static readonly InputRange ZeroToOne = new InputRange(0.0f, 1f, InputRangeType.ZeroToOne);
        public static readonly InputRange ZeroToMinusOne = new InputRange(0.0f, -1f, InputRangeType.ZeroToMinusOne);
        public static readonly InputRange OneToZero = new InputRange(1f, 0.0f, InputRangeType.OneToZero);
        public static readonly InputRange MinusOneToZero = new InputRange(-1f, 0.0f, InputRangeType.MinusOneToZero);
        ...
        public bool Includes(float value) => !this.Excludes(value);

        public bool Excludes(float value)
        {
            return this.Type == InputRangeType.None || (double) value < (double) Mathf.Min(this.Value0, this.Value1) || (double) value > (double) Mathf.Max(this.Value0, this.Value1);
        }
