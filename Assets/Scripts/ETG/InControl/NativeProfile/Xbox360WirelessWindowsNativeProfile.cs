...
// Type: InControl.NativeProfile.Xbox360WirelessWindowsNativeProfile
...
namespace InControl.NativeProfile
{
  ...
  public class Xbox360WirelessWindowsNativeProfile : NativeInputDeviceProfile
  {
    ...
    {
      this.Name = "Xbox 360 Wireless Controller";
      this.Meta = "Xbox 360 Wireless Controller on Windows";
      ...
      this.Matchers = new NativeInputDeviceMatcher[1]
      {
        new NativeInputDeviceMatcher()
        {
          ...
          ProductID = new ushort?((ushort) 673)
        }
      };
