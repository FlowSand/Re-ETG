...
// Type: InControl.NativeProfile.LogitechF710ModeXWindowsNativeProfile
...
public class LogitechF710ModeXWindowsNativeProfile : NativeInputDeviceProfile
{
  ...
  {
    this.Name = "Logitech F710 Mode X Controller";
    this.Meta = "Logitech F710 Mode X Controller on Windows";
