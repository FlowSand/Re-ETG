...
// Type: InControl.NativeProfile.LogitechF710ModeDWindowsNativeProfile
...
namespace InControl.NativeProfile
{
  ...
  public class LogitechF710ModeDWindowsNativeProfile : NativeInputDeviceProfile
  {
    ...
    {
      this.Name = "Logitech F710 Mode D Controller";
      this.Meta = "Logitech F710 Mode D Controller on Windows";
      ...
      this.Matchers = new NativeInputDeviceMatcher[1]
      {
        new NativeInputDeviceMatcher()
        {
          ...
          ProductID = new ushort?((ushort) 49689)
        }
      };
