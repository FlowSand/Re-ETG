...
// Type: InControl.NativeProfile.XInputWindowsNativeProfile
...
public class XInputWindowsNativeProfile : NativeInputDeviceProfile
{
  ...
  {
    this.Name = "XInput Controller";
    this.Meta = "XInput Controller on Windows";
    ...
    this.Matchers = new NativeInputDeviceMatcher[1]
    {
      ...
      {
        DriverType = new NativeDeviceDriverType?(NativeDeviceDriverType.XInput)
      }
    };
    this.ButtonMappings = new InputControlMapping[14]
    {
