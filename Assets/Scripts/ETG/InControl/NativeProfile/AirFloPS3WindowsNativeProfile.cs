...
// Type: InControl.NativeProfile.AirFloPS3WindowsNativeProfile
...
namespace InControl.NativeProfile
{
  ...
  public class AirFloPS3WindowsNativeProfile : NativeInputDeviceProfile
  {
    ...
    {
      this.Name = "Air Flo PS3 Controller";
      this.Meta = "Air Flo PS3 Controller on Windows";
      ...
      this.Matchers = new NativeInputDeviceMatcher[1]
      {
        ...
        {
          VendorID = new ushort?((ushort) 8406),
          ProductID = new ushort?((ushort) 22301)
        }
      };
