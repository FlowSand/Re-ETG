...
// Type: InControl.NativeProfile.LogitechF510ModeXWindowsNativeProfile
...
namespace InControl.NativeProfile
{
  ...
  public class LogitechF510ModeXWindowsNativeProfile : NativeInputDeviceProfile
  {
    ...
    {
      this.Name = "Logitech F510 Mode X Controller";
      this.Meta = "Logitech F510 Mode X Controller on Windows";
