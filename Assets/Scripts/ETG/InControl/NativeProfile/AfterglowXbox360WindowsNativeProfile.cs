...
// Type: InControl.NativeProfile.AfterglowXbox360WindowsNativeProfile
...
namespace InControl.NativeProfile
{
  ...
  public class AfterglowXbox360WindowsNativeProfile : NativeInputDeviceProfile
  {
    ...
    {
      this.Name = "Afterglow Xbox 360 Controller";
      this.Meta = "Afterglow Xbox 360 Controller on Windows";
      ...
      this.AnalogMappings = new InputControlMapping[13]
      {
        new InputControlMapping()
        {
