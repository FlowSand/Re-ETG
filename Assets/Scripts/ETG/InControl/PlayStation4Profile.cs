...
// Type: InControl.PlayStation4Profile
...
namespace InControl
{
  ...
  public class PlayStation4Profile : UnityInputDeviceProfile
  {
    ...
    {
      string str = "®";
      this.Name = $"DUALSHOCK{str}4 wireless controller";
      this.Meta = $"DUALSHOCK{str}4 wireless controller on PlayStation{str}4 system";
      this.DeviceClass = InputDeviceClass.Controller;
      this.DeviceStyle = InputDeviceStyle.PlayStation4;
      this.IncludePlatforms = new string[1]{ "PS4" };
      this.JoystickRegex = new string[1]{ "controller" };
