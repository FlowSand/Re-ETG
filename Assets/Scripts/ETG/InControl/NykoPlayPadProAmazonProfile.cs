...
// Type: InControl.NykoPlayPadProAmazonProfile
...
namespace InControl
{
  ...
  public class NykoPlayPadProAmazonProfile : UnityInputDeviceProfile
  {
    ...
    {
      this.Name = "Nyko PlayPad Pro";
      this.Meta = "Nyko PlayPad Pro on Amazon Fire TV";
      this.DeviceClass = InputDeviceClass.Controller;
      this.IncludePlatforms = new string[1]{ "Amazon AFT" };
      this.JoystickNames = new string[1]{ "NYKO PLAYPAD PRO" };
