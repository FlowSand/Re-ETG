...
// Type: InControl.MogaProPowerAndroidProfile
...
namespace InControl
{
  ...
  public class MogaProPowerAndroidProfile : UnityInputDeviceProfile
  {
    ...
    {
      this.Name = "Moga Pro Power";
      this.Meta = "Moga Pro Power on Android";
      this.DeviceClass = InputDeviceClass.Controller;
      this.IncludePlatforms = new string[1]{ "Android" };
      this.JoystickNames = new string[1]{ "Moga Pro 2 HID" };
      ...
      this.AnalogMappings[0].SourceRange = InputRange.ZeroToOne;
      this.AnalogMappings[1].SourceRange = InputRange.ZeroToOne;
    }
  }
}
