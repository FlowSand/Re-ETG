...
// Type: InControl.EightBitdoSNES30MacNativeProfile
...
public class EightBitdoSNES30MacNativeProfile : NativeInputDeviceProfile
{
  public EightBitdoSNES30MacNativeProfile()
  {
    ...
    this.Meta = "8Bitdo SNES30 Controller on Mac";
    ...
    this.Matchers = new NativeInputDeviceMatcher[2]
    {
      ...
      {
        VendorID = new ushort?((ushort) 10272),
        ProductID = new ushort?((ushort) 9)
      },
      new NativeInputDeviceMatcher()
      {
        VendorID = new ushort?((ushort) 4661),
        ProductID = new ushort?((ushort) 43808)
      }
    };
