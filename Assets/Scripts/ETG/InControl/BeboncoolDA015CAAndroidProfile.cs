...
// Type: InControl.BeboncoolDA015CAAndroidProfile
...
namespace InControl
{
  ...
  public class BeboncoolDA015CAAndroidProfile : UnityInputDeviceProfile
  {
    ...
    {
      this.Name = "BEBONCOOL DA015-CA Controller";
      this.Meta = "BEBONCOOL DA015-CA Controller on Android";
      this.DeviceClass = InputDeviceClass.Controller;
      this.DeviceStyle = InputDeviceStyle.Xbox360;
      this.IncludePlatforms = new string[1]{ "Android" };
      this.JoystickNames = new string[1]{ "BBC-GAME" };
