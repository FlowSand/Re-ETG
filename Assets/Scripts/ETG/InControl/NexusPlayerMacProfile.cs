...
// Type: InControl.NexusPlayerMacProfile
...
public class NexusPlayerMacProfile : UnityInputDeviceProfile
{
  ...
  {
    this.Name = "Nexus Player Controller";
    this.Meta = "Nexus Player Controller on OS X";
    this.DeviceClass = InputDeviceClass.Controller;
    this.IncludePlatforms = new string[1]{ "OS X" };
    this.JoystickNames = new string[1]{ "Unknown Gamepad" };
