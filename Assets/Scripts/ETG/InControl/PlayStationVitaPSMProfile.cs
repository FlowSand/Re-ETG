...
// Type: InControl.PlayStationVitaPSMProfile
...
namespace InControl
{
  ...
  public class PlayStationVitaPSMProfile : UnityInputDeviceProfile
  {
    ...
    {
      this.Name = "PlayStation Mobile";
      this.Meta = "PlayStation Mobile on Vita";
      this.DeviceClass = InputDeviceClass.Controller;
      this.DeviceStyle = InputDeviceStyle.PlayStationVita;
      this.IncludePlatforms = new string[4]
      {
        "PSM UNITY FOR PSM",
        "PSM ON PS VITA",
        "PS VITA",
      ...
      this.JoystickNames = new string[1]{ "PS Vita" };
