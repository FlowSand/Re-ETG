...
{
  public static string GetUnifiedControllerButtonTag(
    InputControlType controlType,
    GameOptions.ControllerSymbology symbology,
    GungeonActions gungeonActions = null)
  {
    string buttonSpriteName = UIControllerButtonHelper.GetControllerButtonSpriteName(controlType, symbology);
    return string.IsNullOrEmpty(buttonSpriteName) ? controlType.ToString() : $"[sprite \"{buttonSpriteName}\"]";
  }
    ...
    GameOptions.ControllerSymbology symbology)
  {
    ...
    switch (weirdControl)
    {
      case "RightStick":
        ...
        break;
      case "Teleporter":
        str = "teleport_active_001";
        break;
    }
    return $"[sprite \"{str}\"]";
  }

  public static string GetControllerButtonSpriteName(
    InputControlType controlType,
    GameOptions.ControllerSymbology symbology,
    GungeonActions gungeonActions = null)
  {
      ...
      case GameOptions.ControllerSymbology.PS4:
        switch (controlType)
        {
          ...
          case InputControlType.Pause:
            return "ps4_options_share";
          default:
            return controlType == InputControlType.TouchPadButton ? "ps4_flat" : string.Empty;
        }
