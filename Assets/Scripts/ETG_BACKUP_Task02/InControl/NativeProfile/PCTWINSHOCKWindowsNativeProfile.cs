...
// Type: InControl.NativeProfile.PCTWINSHOCKWindowsNativeProfile
...
public class PCTWINSHOCKWindowsNativeProfile : NativeInputDeviceProfile
{
  ...
  {
    this.Name = "PC TWIN SHOCK";
    this.Meta = "PC TWIN SHOCK on Windows";
    this.DeviceClass = InputDeviceClass.Controller;
    this.DeviceStyle = InputDeviceStyle.PlayStation2;
    this.IncludePlatforms = new string[1]{ "Windows" };
    this.Matchers = new NativeInputDeviceMatcher[1]
    {
      new NativeInputDeviceMatcher()
      {
        VendorID = new ushort?((ushort) 121),
        ProductID = new ushort?((ushort) 6)
      }
    };
