...
// Type: InControl.NativeProfile.LogitechF510ModeDWindowsNativeProfile
...
public class LogitechF510ModeDWindowsNativeProfile : NativeInputDeviceProfile
{
  ...
  {
    this.Name = "Logitech F510 Mode D Controller";
    this.Meta = "Logitech F510 Mode D Controller on Windows";
    ...
    this.Matchers = new NativeInputDeviceMatcher[1]
    {
      new NativeInputDeviceMatcher()
      {
        ...
        ProductID = new ushort?((ushort) 49688)
      }
    };
