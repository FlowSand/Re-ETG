...
public class AkPlaylistArray : IDisposable
{
  ...
  internal static IntPtr getCPtr(AkPlaylistArray obj) => obj == null ? IntPtr.Zero : obj.swigCPtr;
  ...
  public uint Reserved() => AkSoundEnginePINVOKE.CSharp_AkPlaylistArray_Reserved(this.swigCPtr);

  public void Term() => AkSoundEnginePINVOKE.CSharp_AkPlaylistArray_Term(this.swigCPtr);

  public uint Length() => AkSoundEnginePINVOKE.CSharp_AkPlaylistArray_Length(this.swigCPtr);

  public bool IsEmpty() => AkSoundEnginePINVOKE.CSharp_AkPlaylistArray_IsEmpty(this.swigCPtr);

  public AkPlaylistItem Exists(AkPlaylistItem in_Item)
  {
    IntPtr cPtr = AkSoundEnginePINVOKE.CSharp_AkPlaylistArray_Exists(this.swigCPtr, AkPlaylistItem.getCPtr(in_Item));
  ...
  {
    IntPtr cPtr = AkSoundEnginePINVOKE.CSharp_AkPlaylistArray_AddLast__SWIG_1(this.swigCPtr, AkPlaylistItem.getCPtr(in_rItem));
    return !(cPtr == IntPtr.Zero) ? new AkPlaylistItem(cPtr, false) : (AkPlaylistItem) null;
  }
  ...
  public void RemoveLast() => AkSoundEnginePINVOKE.CSharp_AkPlaylistArray_RemoveLast(this.swigCPtr);
  ...
  public void RemoveAll() => AkSoundEnginePINVOKE.CSharp_AkPlaylistArray_RemoveAll(this.swigCPtr);
