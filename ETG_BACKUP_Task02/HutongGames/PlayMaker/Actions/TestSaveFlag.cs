...
// Type: HutongGames.PlayMaker.Actions.TestSaveFlag
...
public class TestSaveFlag : FsmStateAction
{
  ...
  public override string ErrorCheck()
  {
    ...
    {
      if (this.flagValues[index] == GungeonFlags.NONE)
  ...
  private void DoCheck()
  {
    ...
    for (int index = 0; index < this.flagValues.Length; ++index)
    {
      if (GameStatsManager.Instance.GetFlag(this.flagValues[index]) != this.values[index].Value)
      {
