...
// Type: HutongGames.PlayMaker.Actions.iTweenScaleBy
...
[HutongGames.PlayMaker.Tooltip("Multiplies a GameObject's scale over time.")]
public class iTweenScaleBy : iTweenFsmAction
{
  ...
  public FsmString id;
  [HutongGames.PlayMaker.Tooltip("A vector that will multiply current GameObjects scale.")]
  [RequiredField]
