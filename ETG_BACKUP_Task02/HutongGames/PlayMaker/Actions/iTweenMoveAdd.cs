...
// Type: HutongGames.PlayMaker.Actions.iTweenMoveAdd
...
[HutongGames.PlayMaker.Tooltip("Translates a GameObject's position over time.")]
public class iTweenMoveAdd : iTweenFsmAction
{
  ...
  public FsmString id;
  [HutongGames.PlayMaker.Tooltip("A vector that will be added to a GameObjects position.")]
  [RequiredField]
