...
// Type: InControl.DroidBoxXboxAndroidProfile
...
public class DroidBoxXboxAndroidProfile : UnityInputDeviceProfile
{
  ...
  {
    this.Name = "DroidBOX GPD XD PlayON - Xbox Mode";
    this.Meta = "DroidBOX GPD XD PlayON - Xbox Mode on Android";
    this.DeviceClass = InputDeviceClass.Controller;
    this.IncludePlatforms = new string[1]{ "Android" };
    this.JoystickNames = new string[1]{ "XBOX" };
