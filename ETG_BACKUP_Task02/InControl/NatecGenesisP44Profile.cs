...
// Type: InControl.NatecGenesisP44Profile
...
public class NatecGenesisP44Profile : UnityInputDeviceProfile
{
  ...
  {
    this.Name = "Natec Genesis P44 Controller";
    this.Meta = "Natec Genesis P44 Controller on Windows";
    this.DeviceClass = InputDeviceClass.Controller;
    this.IncludePlatforms = new string[1]{ "Windows" };
    this.JoystickNames = new string[1]{ "EX10 GAMEPAD" };
