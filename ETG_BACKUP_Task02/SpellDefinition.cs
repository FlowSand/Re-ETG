...
public class SpellDefinition
{
  ...
  public static SpellDefinition[] AllSpells = new SpellDefinition[8]
  {
    new SpellDefinition()
    {
      Name = "KnitBone",
  ...
  {
    return ((IEnumerable<SpellDefinition>) SpellDefinition.AllSpells).FirstOrDefault<SpellDefinition>((Func<SpellDefinition, bool>) (spell => spell.Name == Name));
  }
}
